...
| `src/main/resources/data/*/recipe/`; `src/*/resources/flans_content/*/data/*/recipe/` | Minecraft 1.21.1 loads recipes from singular `recipe/`. The port moved authored main and packaged-pack JSON from `recipes/` and changed output schema; Java compilation alone cannot verify these resources. |
