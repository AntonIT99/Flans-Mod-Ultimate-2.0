...
class ConfigSpecValuesTest
{
    ...
    private ForgeConfigSpec.BooleanValue flag;
    private ForgeConfigSpec.IntValue count;
    private ForgeConfigSpec.DoubleValue ratio;
    private ForgeConfigSpec.EnumValue<Flavour> flavour;
