...
public class ModelTwoSeatBiplane extends ModelPlane
{
	public ModelTwoSeatBiplane()
	{
		...
		byte width = 20;
		byte boatDepth = 4;
		bodyModel[0].addBox((float) -length / 2, (float) -width / 2 + 2, -3F, length, width - 4, 4, 0.0F);
		bodyModel[0].setPosition(0.0F, boatDepth, 0.0F);

		bodyModel[1].addBox((float) -length / 2 + 2, -sidePieceHeight - 1F, -1F, length - 4, sidePieceHeight, 2, 0.0F);
		bodyModel[1].setPosition((float) -length / 2 + 1, boatDepth, 0.0F);

		bodyModel[2].addBox((float) -length / 2 + 2, -sidePieceHeight - 1F, -1F, length - 4, sidePieceHeight, 2, 0.0F);
		bodyModel[2].setPosition((float) length / 2 - 1, boatDepth, 0.0F);

		bodyModel[3].addBox((float) -length / 2 + 2, -sidePieceHeight - 1F, -1F, length - 4, sidePieceHeight, 2, 0.0F);
		bodyModel[3].setPosition(0.0F, boatDepth, (float) -width / 2 + 1);

		bodyModel[4].addBox((float) -length / 2 + 2, -sidePieceHeight - 1F, -1F, length - 4, sidePieceHeight, 2, 0.0F);
		bodyModel[4].setPosition(0.0F, boatDepth, (float) width / 2 - 1);
		...
		bayModel[0].addBox((float) -length / 2, (float) -width / 2 + 2, -3F, length, width - 4, 4, 0.0F);
		bayModel[0].setPosition(length, boatDepth, 0.0F);
		bayModel[1].addBox((float) -length / 2 + 2, -sidePieceHeight - 1F, -1F, length - 4, sidePieceHeight, 2, 0.0F);
		bayModel[1].setPosition(length - (float) length / 2 + 1, boatDepth, 0.0F);
		bayModel[2].addBox((float) -length / 2 + 2, -sidePieceHeight - 1F, -1F, length - 4, sidePieceHeight, 2, 0.0F);
		bayModel[2].setPosition(length + (float) length / 2 - 1, boatDepth, 0.0F);
		bayModel[3].addBox((float) -length / 2 + 2, -sidePieceHeight - 1F, -1F, length - 4, sidePieceHeight, 2, 0.0F);
		bayModel[3].setPosition(length, boatDepth, (float) -width / 2 + 1);
		bayModel[4].addBox((float) -length / 2 + 2, -sidePieceHeight - 1F, -1F, length - 4, sidePieceHeight, 2, 0.0F);
		bayModel[4].setPosition(length, boatDepth, (float) width / 2 - 1);
