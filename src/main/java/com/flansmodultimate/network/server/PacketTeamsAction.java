...
/** Small validated intent packet for the Teams screens. */
@NoArgsConstructor
public final class PacketTeamsAction implements IServerPacket
{
    public enum Action { SELECT_TEAM, SELECT_CLASS, CAST_VOTE, OPEN_TEAM, OPEN_CLASS, OPEN_SCOREBOARD }
    ...
    public static PacketTeamsAction selectTeam(String id) { return new PacketTeamsAction(Action.SELECT_TEAM, id); }
    public static PacketTeamsAction selectClass(String id) { return new PacketTeamsAction(Action.SELECT_CLASS, id); }
    public static PacketTeamsAction castVote(int option) { return new PacketTeamsAction(Action.CAST_VOTE, Integer.toString(option)); }
    public static PacketTeamsAction openTeamMenu() { return new PacketTeamsAction(Action.OPEN_TEAM, ""); }
    public static PacketTeamsAction openClassMenu() { return new PacketTeamsAction(Action.OPEN_CLASS, ""); }
    public static PacketTeamsAction openScoreboard() { return new PacketTeamsAction(Action.OPEN_SCOREBOARD, ""); }
    ...
    public void handleServerSide(@NotNull ServerPlayer player, @NotNull ServerLevel level)
    {
        ...
        switch (action)
        {
            case OPEN_TEAM -> manager.syncPlayer(player, PacketTeamsState.OpenScreen.TEAM_SELECT);
            case OPEN_CLASS -> {
