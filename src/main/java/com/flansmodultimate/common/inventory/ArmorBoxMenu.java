...
public class ArmorBoxMenu extends AbstractContainerMenu
{
    ...
    public ArmorBoxMenu(int id, Inventory playerInv)
    {
        this(id, playerInv, BlockPos.ZERO, null);
    }

    public ArmorBoxMenu(int id, Inventory playerInv, BlockPos pos)
    {
        this(id, playerInv, pos, null);
    }
    ...
    {
        return access.evaluate((level, pos) -> level.getBlockState(pos).getBlock() instanceof ArmorBoxBlock, true);
    }
