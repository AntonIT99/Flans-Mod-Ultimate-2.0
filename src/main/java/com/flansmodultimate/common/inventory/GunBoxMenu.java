...
public class GunBoxMenu extends AbstractContainerMenu
{
    ...
    public GunBoxMenu(int id, Inventory playerInv)
    {
        this(id, playerInv, BlockPos.ZERO, null);
    }

    public GunBoxMenu(int id, Inventory playerInv, BlockPos pos)
    {
    ...
    {
        return access.evaluate((level, pos) -> level.getBlockState(pos).getBlock() instanceof GunBoxBlock, true);
    }
}
