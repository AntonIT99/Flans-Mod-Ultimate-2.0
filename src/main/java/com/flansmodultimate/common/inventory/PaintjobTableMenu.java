...
public class PaintjobTableMenu extends AbstractContainerMenu
{
    ...
    public PaintjobTableMenu(int id, Inventory playerInv)
    {
    ...
    public PaintjobTableMenu(int id, Inventory playerInv, BlockPos blockPos)
    {
        ...
        ItemStackHandler dummyHandler = new ItemStackHandler(2);
        addSlot(new SlotItemHandler(dummyHandler, 0, 187, GUI_TOP_H + 17));
        addSlot(new SlotItemHandler(dummyHandler, 1, 187, GUI_TOP_H + 71));
