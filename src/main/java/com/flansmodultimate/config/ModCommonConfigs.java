...
public class ModCommonConfigs
{
    ...
    public static final ForgeConfigSpec.DoubleValue driveableAndDeployableUpdateRange;
    ...
    static {
        ...
        driveableAndDeployableUpdateRange = builder
            .comment("Range in blocks for driveables and deployable guns to be updated.")
            .defineInRange("driveableAndDeployableUpdateRange", 512.0, 0.0, 1024.0);
        builder.pop();
