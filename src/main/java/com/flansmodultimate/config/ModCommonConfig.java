...
public final class ModCommonConfig
{
    ...
    private static final ModConfigSpec.BooleanValue ADD_GUNPOWDER_RECIPE;
    private static final ModConfigSpec.ConfigValue<String> DEFAULT_VEHICLE_ENGINE;
    private static final ModConfigSpec.ConfigValue<String> DEFAULT_PLANE_ENGINE;
    private static final ModConfigSpec.ConfigValue<String> DEFAULT_MECHA_ENGINE;
    private static final ModConfigSpec.DoubleValue NAME_TAG_RENDER_RANGE;
    private static final ModConfigSpec.DoubleValue NAME_TAG_SNEAK_RENDER_RANGE;
    private static final ModConfigSpec.IntValue NOTICE_SPAWN_KILL_TIME;
    private static final ModConfigSpec.BooleanValue FORCE_NEW_EXPLOSIONS_BREAK_BLOCKS;
    private static final ModConfigSpec.BooleanValue DRIVEABLE_COLLISIONS_BREAK_BLOCKS;
    private static final ModConfigSpec.BooleanValue AUTO_REFILL_VEHICLE_AMMO;
    private static final ModConfigSpec.BooleanValue GUNS_IN_DESTROYED_PARTS_WORK;
    private static final ModConfigSpec.IntValue AMBIENT_MOB_ARMOR_SPAWN_RATE;
    private static final ModConfigSpec.BooleanValue DISABLE_DUAL_WIELDING;
    private static final ModConfigSpec.BooleanValue RELOAD_ON_EMPTY_FIRE;
    private static final ModConfigSpec.DoubleValue NEW_DAMAGE_SYSTEM_BLAST_RADIUS_REFERENCE;
    private static final ModConfigSpec.DoubleValue NEW_DAMAGE_SYSTEM_BLAST_FALLOFF_SHARPNESS;
    private static final ModConfigSpec.DoubleValue KINETIC_PENETRATION_REFERENCE;
    private static final ModConfigSpec.ConfigValue<List<? extends String>> FLUID_FUELS_RAW;
    private static final ModConfigSpec.BooleanValue FORCE_LEGACY_PLANE_PHYSICS;
    private static final ModConfigSpec.BooleanValue FORCE_LEGACY_VEHICLE_PHYSICS;
    private static final ModConfigSpec.BooleanValue ENABLE_AIRCRAFT_ROLL_SELF_LEVELING;
    private static final ModConfigSpec.DoubleValue REALISTIC_AIRCRAFT_REFERENCE_SPEED_SCALE;
    private static final ModConfigSpec.DoubleValue REALISTIC_AIRCRAFT_THROTTLE_RESPONSE;
    private static final ModConfigSpec.DoubleValue REALISTIC_PLANE_SPEED_SCALE;
    private static final ModConfigSpec.DoubleValue REALISTIC_GROUND_VEHICLE_SPEED_SCALE;
    private static final ModConfigSpec.DoubleValue MAX_PLANE_SPEED_KMH;
    private static final ModConfigSpec.DoubleValue MAX_VEHICLE_SPEED_KMH;
    private static final ModConfigSpec.BooleanValue FORCE_LEGACY_VEHICLE_KNOCKBACK;
    private static final ModConfigSpec.DoubleValue VEHICLE_KNOCKBACK_REFERENCE_MASS_KG;
    private static final ModConfigSpec.DoubleValue FALLBACK_GROUND_VEHICLE_MASS_TONS;
    private static final ModConfigSpec.DoubleValue FALLBACK_AIRCRAFT_MASS_TONS;
    private static final ModConfigSpec.DoubleValue FALLBACK_AA_GUN_MASS_TONS;
    private static final ModConfigSpec.DoubleValue REALISTIC_VEHICLE_HEALTH_SCALE;
    private static final ModConfigSpec.DoubleValue MAX_ARMOR_IMPACT_ANGLE_DEG;
    private static final ModConfigSpec.DoubleValue ARMORED_BLAST_RESISTANCE_KPA_PER_MM;
    private static final ModConfigSpec.DoubleValue MINIMUM_BLAST_DISTANCE_METERS;
    private static final ModConfigSpec.DoubleValue MAX_EXPLOSION_RADIUS;
    private static final ModConfigSpec.DoubleValue MAX_BLAST_RADIUS;
