...
public class ModClient
{
    ...
    public static void setShotState(int state) { /* noop for now - replaced NeoForge compatibility layer */ }
    public static void setLastBulletReload(int count) { /* noop for now - replaced NeoForge compatibility layer */ }

    public static int getLastBulletReload() { return lastBulletReload; }
    public static int getShotState() { return shotState; }
}
