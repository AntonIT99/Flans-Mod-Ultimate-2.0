...
public final class ParticleHelper
{
    ...
    private static Optional<ParticleOptions> toOptions(String raw)
    {
        ...
        return switch (s)
        {
            ...
            case "spell" -> Optional.of((ParticleOptions) ParticleTypes.EFFECT);
            case "instantspell" -> Optional.of((ParticleOptions) ParticleTypes.INSTANT_EFFECT);
            case "mobspell" -> Optional.of((ParticleOptions) ParticleTypes.ENTITY_EFFECT);
            case "mobspellambient" -> Optional.of((ParticleOptions) ParticleTypes.ENTITY_EFFECT);
            ...
            default -> {
                if (!s.contains(":"))
                    yield Optional.of(ResourceLocation.fromNamespaceAndPath("minecraft", s))
                        .map(rl -> BuiltInRegistries.PARTICLE_TYPE.get(rl))
