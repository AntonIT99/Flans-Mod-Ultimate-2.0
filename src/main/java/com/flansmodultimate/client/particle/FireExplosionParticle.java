...
public class FireExplosionParticle extends ParticleBase
{
    ...
    /** Largest quad size at which culling by the particle's centre is still invisible. */
    ...
    /**
     * The engine culls against the small collision box rather than the drawn quad, so a fireball
     * scaled to a large explosion would vanish whenever its centre left the screen.
     */
    @Override
    public boolean shouldCull()
    {
        return quadSize < MAX_CULLED_SIZE;
    }
