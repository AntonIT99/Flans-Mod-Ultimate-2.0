...
public interface ConfigTarget
{
    ...
    Object get(ModConfigSpec.ConfigValue<?> value);

    /** Applies a change the player made with a single click. */
    void set(ModConfigSpec.ConfigValue<?> value, Object newValue);
     ...
     */
    void setWhileDragging(ModConfigSpec.ConfigValue<?> value, Object newValue);
