...
public class GrenadeRenderer extends FlanEntityRenderer<Grenade>
{
    ...
    {
        ShootableType configType = grenade.getConfigType();
        if (configType == null)
            return;
        ...
        super.render(grenade, entityYaw, partialTicks, poseStack, buffer, configType.isHasLight() ? LightTexture.FULL_BRIGHT : packedLight);
