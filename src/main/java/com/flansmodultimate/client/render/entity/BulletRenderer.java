...
public class BulletRenderer extends FlanEntityRenderer<Bullet>
{
    ...
    {
        BulletType configType = bullet.getConfigType();
        if (configType == null)
            return;
        ...
        super.render(bullet, entityYaw, partialTicks, poseStack, buffer, configType.isHasLight() ? LightTexture.FULL_BRIGHT : packedLight);
