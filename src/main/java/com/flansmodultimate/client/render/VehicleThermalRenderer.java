...
public final class VehicleThermalRenderer
{
    ...
    private static final MultiBufferSource.BufferSource buffers = MultiBufferSource.immediate(new BufferBuilder(256));
    ...
    public static void render(RenderLevelStageEvent event)
    {
        ...
        try
        {
            ...
            for (Entity entity : mc.level.entitiesForRendering())
            {
                ...
                renderEntity(entity, camera, event.getPartialTick(), event.getPoseStack(), maskBuffers);
            }
            buffers.endBatch();
            renderingMask = false;
