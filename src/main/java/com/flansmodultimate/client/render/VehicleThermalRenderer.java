...
public final class VehicleThermalRenderer
{
    ...
    private record HeatVertexConsumer(VertexConsumer delegate) implements VertexConsumer
    {
        ...
        @Override public VertexConsumer setColor(int r, int g, int b, int a) { delegate.setColor(255, 255, 255, 255); return this; }
        @Override public VertexConsumer setUv(float u, float v) { delegate.setUv(0.5F, 0.5F); return this; }
        @Override public VertexConsumer setUv1(int u, int v) { delegate.setOverlay(OverlayTexture.NO_OVERLAY); return this; }
        @Override public VertexConsumer setUv2(int u, int v) { delegate.setLight(LightTexture.FULL_BRIGHT); return this; }
