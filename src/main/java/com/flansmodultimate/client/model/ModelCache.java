...
public final class ModelCache
{
    ...
    public static IModelBase loadModel(String modelClassName, InfoType type, @Nullable IModelBase defaultModel)
    {
        ...
        if (StringUtils.isNotBlank(modelClassName))
        {
            ...
            {
                Map<String, DynamicReference> refsMap = ContentManager.getModelReferences().get(type.getContentPack());
                DynamicReference actualClassName = refsMap != null ? refsMap.get(modelClassName) : null;
