...
public class ModelPhilippineBoots extends ModelCustomArmour {
   int textureX = 128;
   int textureY = 128;

   public ModelPhilippineBoots() {
      leftLegModel = new ModelRendererTurbo[1];
      leftLegModel[0] = new ModelRendererTurbo(this, 105, 65, textureX, textureY);
      ...
      rightLegModel[0] = new ModelRendererTurbo(this, 1, 73, textureX, textureY);
