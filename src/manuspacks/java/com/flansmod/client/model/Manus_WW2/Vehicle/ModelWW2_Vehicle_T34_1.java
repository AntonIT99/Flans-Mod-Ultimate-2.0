...
public class ModelWW2_Vehicle_T34_1 extends ModelVehicle {
   int textureX = 512;
   int textureY = 512;
   ...
   public ModelWW2_Vehicle_T34_1() {
      ...
      bodyModel[58].addShape3D(0.0F, 0.0F, 0.0F, new Shape2D(new Coord2D[]{new Coord2D(0.0, 0.0, 0, 0), new Coord2D(20.0, 0.0, 20, 0), new Coord2D(20.0, 10.0, 20, 10), new Coord2D(8.0, 10.0, 8, 10)}), 13.0F, 20, 10, 55, 13, 0, new float[]{13.0F, 12.0F, 10.0F, 20.0F});
      bodyModel[58].setRotationPoint(-50.0F, -13.0F, 25.5F);
      bodyModel[59].addShape3D(0.0F, 0.0F, 0.0F, new Shape2D(new Coord2D[]{new Coord2D(0.0, 0.0, 0, 0), new Coord2D(20.0, 0.0, 20, 0), new Coord2D(20.0, 10.0, 20, 10), new Coord2D(8.0, 10.0, 8, 10)}), 13.0F, 20, 10, 55, 13, 0, new float[]{13.0F, 12.0F, 10.0F, 20.0F});
      ...
      turretModel[13].rotateAngleX = (float) (Math.PI / 2);
