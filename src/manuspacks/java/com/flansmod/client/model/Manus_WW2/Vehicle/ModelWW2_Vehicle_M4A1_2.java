...
public class ModelWW2_Vehicle_M4A1_2 extends ModelVehicle {
   int textureX = 512;
   int textureY = 512;

   public ModelWW2_Vehicle_M4A1_2() {
      ...
      bodyModel[133].addShape3D(0.0F, 0.0F, 0.0F, new Shape2D(new Coord2D[]{new Coord2D(0.0, 0.0, 0, 0), new Coord2D(1.0, 0.0, 1, 0), new Coord2D(4.0, 7.0, 4, 7), new Coord2D(4.0, 8.0, 4, 8), new Coord2D(3.0, 7.0, 3, 7)}), 6.0F, 4, 8, 20, 6, 0, new float[]{8.0F, 2.0F, 1.0F, 8.0F, 1.0F});
      bodyModel[133].rotateAngleX = (float) (Math.PI / 2);
      bodyModel[133].setRotationPoint(22.0F, -30.0F, -11.0F);
      bodyModel[134].addShape3D(0.0F, 0.0F, 0.0F, new Shape2D(new Coord2D[]{new Coord2D(0.0, 0.0, 0, 0), new Coord2D(7.0, 3.0, 7, 3), new Coord2D(7.0, 4.0, 7, 4), new Coord2D(0.0, 1.0, 0, 1)}), 6.0F, 7, 4, 18, 6, 0, new float[]{1.0F, 8.0F, 1.0F, 8.0F});
      bodyModel[134].rotateAngleX = (float) (Math.PI / 2);
      ...
      bodyModel[136].addShape3D(0.0F, 0.0F, 0.0F, new Shape2D(new Coord2D[]{new Coord2D(0.0, 3.0, 0, 3), new Coord2D(7.0, 0.0, 7, 0), new Coord2D(7.0, 1.0, 7, 1), new Coord2D(0.0, 4.0, 0, 4)}), 6.0F, 7, 4, 18, 6, 0, new float[]{1.0F, 8.0F, 1.0F, 8.0F});
      bodyModel[136].rotateAngleX = (float) (Math.PI / 2);
      bodyModel[136].setRotationPoint(-11.0F, -30.0F, -18.0F);
      bodyModel[137].addShape3D(0.0F, 0.0F, 0.0F, new Shape2D(new Coord2D[]{new Coord2D(0.0, 7.0, 0, 7), new Coord2D(3.0, 0.0, 3, 0), new Coord2D(4.0, 0.0, 4, 0), new Coord2D(1.0, 7.0, 1, 7), new Coord2D(0.0, 8.0, 0, 8)}), 6.0F, 4, 8, 20, 6, 0, new float[]{1.0F, 2.0F, 8.0F, 1.0F, 8.0F});
      bodyModel[137].rotateAngleX = (float) (Math.PI / 2);
      ...
      bodyModel[140].addShape3D(0.0F, 0.0F, 0.0F, new Shape2D(new Coord2D[]{new Coord2D(0.0, 7.0, 0, 7), new Coord2D(3.0, 0.0, 3, 0), new Coord2D(4.0, 0.0, 4, 0), new Coord2D(1.0, 7.0, 1, 7), new Coord2D(0.0, 8.0, 0, 8)}), 6.0F, 4, 8, 20, 6, 0, new float[]{1.0F, 2.0F, 8.0F, 1.0F, 8.0F});
      bodyModel[140].rotateAngleX = (float) (-Math.PI / 2);
      bodyModel[140].setRotationPoint(-18.0F, -24.0F, 11.0F);
      bodyModel[141].addShape3D(0.0F, 0.0F, 0.0F, new Shape2D(new Coord2D[]{new Coord2D(0.0, 3.0, 0, 3), new Coord2D(7.0, 0.0, 7, 0), new Coord2D(7.0, 1.0, 7, 1), new Coord2D(0.0, 4.0, 0, 4)}), 6.0F, 7, 4, 18, 6, 0, new float[]{1.0F, 8.0F, 1.0F, 8.0F});
      bodyModel[141].rotateAngleX = (float) (-Math.PI / 2);
      ...
      bodyModel[143].addShape3D(0.0F, 0.0F, 0.0F, new Shape2D(new Coord2D[]{new Coord2D(0.0, 0.0, 0, 0), new Coord2D(7.0, 3.0, 7, 3), new Coord2D(7.0, 4.0, 7, 4), new Coord2D(0.0, 1.0, 0, 1)}), 6.0F, 7, 4, 18, 6, 0, new float[]{1.0F, 8.0F, 1.0F, 8.0F});
      bodyModel[143].rotateAngleX = (float) (-Math.PI / 2);
      bodyModel[143].setRotationPoint(18.0F, -24.0F, 18.0F);
      bodyModel[144].addShape3D(0.0F, 0.0F, 0.0F, new Shape2D(new Coord2D[]{new Coord2D(0.0, 0.0, 0, 0), new Coord2D(1.0, 0.0, 1, 0), new Coord2D(4.0, 7.0, 4, 7), new Coord2D(4.0, 8.0, 4, 8), new Coord2D(3.0, 7.0, 3, 7)}), 6.0F, 4, 8, 20, 6, 0, new float[]{8.0F, 2.0F, 1.0F, 8.0F, 1.0F});
      bodyModel[144].rotateAngleX = (float) (-Math.PI / 2);
      ...
      bodyModel[177].addShape3D(0.0F, 0.0F, 0.0F, new Shape2D(new Coord2D[]{new Coord2D(0.0, 0.0, 0, 0), new Coord2D(9.0, 0.0, 9, 0), new Coord2D(9.0, 4.0, 9, 4), new Coord2D(8.0, 6.0, 8, 6), new Coord2D(6.0, 7.0, 6, 7), new Coord2D(0.0, 7.0, 0, 7)}), 2.0F, 9, 7, 32, 2, 0, new float[]{7.0F, 6.0F, 3.0F, 3.0F, 4.0F, 9.0F});
      ...
      bodyModel[180].addShape3D(0.0F, 0.0F, 0.0F, new Shape2D(new Coord2D[]{new Coord2D(0.0, 0.0, 0, 0), new Coord2D(9.0, 0.0, 9, 0), new Coord2D(9.0, 4.0, 9, 4), new Coord2D(8.0, 6.0, 8, 6), new Coord2D(6.0, 7.0, 6, 7), new Coord2D(0.0, 7.0, 0, 7)}), 2.0F, 9, 7, 32, 2, 0, new float[]{7.0F, 6.0F, 3.0F, 3.0F, 4.0F, 9.0F});
      ...
      bodyModel[217].addShape3D(0.0F, 0.0F, 0.0F, new Shape2D(new Coord2D[]{new Coord2D(0.0, 0.0, 0, 0), new Coord2D(13.0, 0.0, 13, 0), new Coord2D(13.0, 13.0, 13, 13)}), 56.0F, 13, 13, 45, 56, 0, new float[]{19.0F, 13.0F, 13.0F});
      bodyModel[217].setRotationPoint(45.0F, -15.0F, 28.0F);
      bodyModel[218].addShape3D(0.0F, 0.0F, 0.0F, new Shape2D(new Coord2D[]{new Coord2D(0.0, 0.0, 0, 0), new Coord2D(27.0, 12.0, 27, 12), new Coord2D(27.0, 44.0, 27, 44), new Coord2D(0.0, 56.0, 0, 56)}), 13.0F, 27, 56, 148, 13, 0, new float[]{56.0F, 30.0F, 32.0F, 30.0F});
      bodyModel[218].rotateAngleX = (float) (Math.PI / 2);
      ...
      turretModel[14] = new ModelRendererTurbo(this, 0, 85, textureX, textureY);
      turretModel[15] = new ModelRendererTurbo(this, 0, 95, textureX, textureY);
      turretModel[16] = new ModelRendererTurbo(this, 20, 85, textureX, textureY);
      turretModel[17] = new ModelRendererTurbo(this, 30, 85, textureX, textureY);
      turretModel[18] = new ModelRendererTurbo(this, 0, 105, textureX, textureY);
      turretModel[19] = new ModelRendererTurbo(this, 0, 112, textureX, textureY);
      turretModel[20] = new ModelRendererTurbo(this, 40, 85, textureX, textureY);
      turretModel[21] = new ModelRendererTurbo(this, 40, 95, textureX, textureY);
      turretModel[22] = new ModelRendererTurbo(this, 60, 85, textureX, textureY);
      turretModel[23] = new ModelRendererTurbo(this, 70, 85, textureX, textureY);
      turretModel[24] = new ModelRendererTurbo(this, 40, 105, textureX, textureY);
      turretModel[25] = new ModelRendererTurbo(this, 40, 112, textureX, textureY);
      turretModel[26] = new ModelRendererTurbo(this, 320, 185, textureX, textureY);
      turretModel[27] = new ModelRendererTurbo(this, 0, 75, textureX, textureY);
      turretModel[28] = new ModelRendererTurbo(this, 7, 75, textureX, textureY);
      ...
      turretModel[1].rotateAngleX = (float) (Math.PI / 2);
      ...
      turretModel[10].rotateAngleX = (float) (Math.PI / 2);
      ...
      turretModel[11].rotateAngleX = (float) (Math.PI / 2);
      turretModel[11].rotateAngleY = (float) (-Math.PI / 12);
      ...
      turretModel[14].addBox(-4.5F, -34.0F, -23.0F, 2, 2, 5, 0.0F);
      turretModel[15].addBox(-4.5F, -39.0F, -23.0F, 2, 2, 5, 0.0F);
      turretModel[16].addBox(-5.0F, -61.0F, -23.5F, 3, 30, 1, 0.0F);
      turretModel[17].addBox(-1.0F, -61.0F, -23.5F, 1, 22, 1, 0.0F);
      turretModel[18].addBox(-6.0F, -62.0F, -24.5F, 7, 3, 2, 0.0F);
      turretModel[19].addBox(-5.5F, -40.0F, -24.0F, 6, 2, 2, 0.0F);
      turretModel[20].addBox(-4.5F, -34.0F, 18.0F, 2, 2, 5, 0.0F);
      turretModel[21].addBox(-4.5F, -39.0F, 18.0F, 2, 2, 5, 0.0F);
      turretModel[22].addBox(-5.0F, -61.0F, 22.5F, 3, 30, 1, 0.0F);
      turretModel[23].addBox(-1.0F, -61.0F, 22.5F, 1, 22, 1, 0.0F);
      turretModel[24].addBox(-6.0F, -62.0F, 22.5F, 7, 3, 2, 0.0F);
      turretModel[25].addBox(-5.5F, -40.0F, 22.0F, 6, 2, 2, 0.0F);
      turretModel[26].addShape3D(7.0F, -7.0F, 0.0F, new Shape2D(new Coord2D[]{new Coord2D(4.0, 0.0, 4, 0), new Coord2D(10.0, 0.0, 10, 0), new Coord2D(14.0, 4.0, 14, 4), new Coord2D(14.0, 10.0, 14, 10), new Coord2D(10.0, 14.0, 10, 14), new Coord2D(4.0, 14.0, 4, 14), new Coord2D(0.0, 10.0, 0, 10), new Coord2D(0.0, 4.0, 0, 4)}), 4.0F, 14, 14, 48, 4, 0, new float[]{6.0F, 6.0F, 6.0F, 6.0F, 6.0F, 6.0F, 6.0F, 6.0F});
      turretModel[26].rotateAngleX = (float) (Math.PI / 2);
      turretModel[26].setRotationPoint(-9.0F, -45.0F, -7.0F);
      barrelModel = new ModelRendererTurbo[201];
      ...
      barrelModel[5] = new ModelRendererTurbo(this, 76, 85, textureX, textureY);
      barrelModel[6] = new ModelRendererTurbo(this, 76, 95, textureX, textureY);
      barrelModel[7] = new ModelRendererTurbo(this, 100, 85, textureX, textureY);
      barrelModel[8] = new ModelRendererTurbo(this, 0, 50, textureX, textureY);
      barrelModel[9] = new ModelRendererTurbo(this, 0, 60, textureX, textureY);
      barrelModel[10] = new ModelRendererTurbo(this, 17, 60, textureX, textureY);
      barrelModel[11] = new ModelRendererTurbo(this, 110, 50, textureX, textureY);
      barrelModel[12] = new ModelRendererTurbo(this, 178, 46, textureX, textureY);
      barrelModel[13] = new ModelRendererTurbo(this, 62, 50, textureX, textureY);
      barrelModel[14] = new ModelRendererTurbo(this, 62, 55, textureX, textureY);
      barrelModel[15] = new ModelRendererTurbo(this, 35, 60, textureX, textureY);
      barrelModel[16] = new ModelRendererTurbo(this, 45, 60, textureX, textureY);
      barrelModel[17] = new ModelRendererTurbo(this, 55, 60, textureX, textureY);
      barrelModel[18] = new ModelRendererTurbo(this, 65, 60, textureX, textureY);
      barrelModel[19] = new ModelRendererTurbo(this, 75, 60, textureX, textureY);
      barrelModel[20] = new ModelRendererTurbo(this, 85, 60, textureX, textureY);
      barrelModel[21] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[22] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[23] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[24] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[25] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[26] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[27] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[28] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[29] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[30] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[31] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[32] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[33] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[34] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[35] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[36] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[37] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[38] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[39] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[40] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[41] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[42] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[43] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[44] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[45] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[46] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[47] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[48] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[49] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[50] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[51] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[52] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[53] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[54] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[55] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[56] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[57] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[58] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[59] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[60] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[61] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[62] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[63] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[64] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[65] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[66] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[67] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[68] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[69] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[70] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[71] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[72] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[73] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[74] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[75] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[76] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[77] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[78] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[79] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[80] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[81] = new ModelRendererTurbo(this, 0, 0, textureX, textureY);
      barrelModel[82] = new ModelRendererTurbo(this, 0, 0, textureX, textureY);
      barrelModel[83] = new ModelRendererTurbo(this, 0, 0, textureX, textureY);
      barrelModel[84] = new ModelRendererTurbo(this, 0, 0, textureX, textureY);
      barrelModel[85] = new ModelRendererTurbo(this, 0, 0, textureX, textureY);
      barrelModel[86] = new ModelRendererTurbo(this, 0, 0, textureX, textureY);
      barrelModel[87] = new ModelRendererTurbo(this, 0, 0, textureX, textureY);
      barrelModel[88] = new ModelRendererTurbo(this, 0, 0, textureX, textureY);
      barrelModel[89] = new ModelRendererTurbo(this, 0, 0, textureX, textureY);
      barrelModel[90] = new ModelRendererTurbo(this, 0, 0, textureX, textureY);
      barrelModel[91] = new ModelRendererTurbo(this, 0, 0, textureX, textureY);
      barrelModel[92] = new ModelRendererTurbo(this, 0, 0, textureX, textureY);
      barrelModel[93] = new ModelRendererTurbo(this, 0, 0, textureX, textureY);
      barrelModel[94] = new ModelRendererTurbo(this, 0, 0, textureX, textureY);
      barrelModel[95] = new ModelRendererTurbo(this, 0, 0, textureX, textureY);
      barrelModel[96] = new ModelRendererTurbo(this, 0, 0, textureX, textureY);
      barrelModel[97] = new ModelRendererTurbo(this, 0, 0, textureX, textureY);
      barrelModel[98] = new ModelRendererTurbo(this, 0, 0, textureX, textureY);
      barrelModel[99] = new ModelRendererTurbo(this, 0, 0, textureX, textureY);
      barrelModel[100] = new ModelRendererTurbo(this, 0, 0, textureX, textureY);
      barrelModel[101] = new ModelRendererTurbo(this, 0, 0, textureX, textureY);
      barrelModel[102] = new ModelRendererTurbo(this, 0, 0, textureX, textureY);
      barrelModel[103] = new ModelRendererTurbo(this, 0, 0, textureX, textureY);
      barrelModel[104] = new ModelRendererTurbo(this, 0, 0, textureX, textureY);
      barrelModel[105] = new ModelRendererTurbo(this, 0, 0, textureX, textureY);
      barrelModel[106] = new ModelRendererTurbo(this, 0, 0, textureX, textureY);
      barrelModel[107] = new ModelRendererTurbo(this, 0, 0, textureX, textureY);
      barrelModel[108] = new ModelRendererTurbo(this, 0, 0, textureX, textureY);
      barrelModel[109] = new ModelRendererTurbo(this, 0, 0, textureX, textureY);
      barrelModel[110] = new ModelRendererTurbo(this, 0, 0, textureX, textureY);
      barrelModel[111] = new ModelRendererTurbo(this, 0, 0, textureX, textureY);
      barrelModel[112] = new ModelRendererTurbo(this, 0, 0, textureX, textureY);
      barrelModel[113] = new ModelRendererTurbo(this, 0, 0, textureX, textureY);
      barrelModel[114] = new ModelRendererTurbo(this, 0, 0, textureX, textureY);
      barrelModel[115] = new ModelRendererTurbo(this, 0, 0, textureX, textureY);
      barrelModel[116] = new ModelRendererTurbo(this, 0, 0, textureX, textureY);
      barrelModel[117] = new ModelRendererTurbo(this, 0, 0, textureX, textureY);
      barrelModel[118] = new ModelRendererTurbo(this, 0, 0, textureX, textureY);
      barrelModel[119] = new ModelRendererTurbo(this, 0, 0, textureX, textureY);
      barrelModel[120] = new ModelRendererTurbo(this, 0, 0, textureX, textureY);
      barrelModel[121] = new ModelRendererTurbo(this, 0, 0, textureX, textureY);
      barrelModel[122] = new ModelRendererTurbo(this, 0, 0, textureX, textureY);
      barrelModel[123] = new ModelRendererTurbo(this, 0, 0, textureX, textureY);
      barrelModel[124] = new ModelRendererTurbo(this, 0, 0, textureX, textureY);
      barrelModel[125] = new ModelRendererTurbo(this, 0, 0, textureX, textureY);
      barrelModel[126] = new ModelRendererTurbo(this, 0, 0, textureX, textureY);
      barrelModel[127] = new ModelRendererTurbo(this, 0, 0, textureX, textureY);
      barrelModel[128] = new ModelRendererTurbo(this, 0, 0, textureX, textureY);
      barrelModel[129] = new ModelRendererTurbo(this, 0, 0, textureX, textureY);
      barrelModel[130] = new ModelRendererTurbo(this, 0, 0, textureX, textureY);
      barrelModel[131] = new ModelRendererTurbo(this, 0, 0, textureX, textureY);
      barrelModel[132] = new ModelRendererTurbo(this, 0, 0, textureX, textureY);
      barrelModel[133] = new ModelRendererTurbo(this, 0, 0, textureX, textureY);
      barrelModel[134] = new ModelRendererTurbo(this, 0, 0, textureX, textureY);
      barrelModel[135] = new ModelRendererTurbo(this, 0, 0, textureX, textureY);
      barrelModel[136] = new ModelRendererTurbo(this, 0, 0, textureX, textureY);
      barrelModel[137] = new ModelRendererTurbo(this, 0, 0, textureX, textureY);
      barrelModel[138] = new ModelRendererTurbo(this, 0, 0, textureX, textureY);
      barrelModel[139] = new ModelRendererTurbo(this, 0, 0, textureX, textureY);
      barrelModel[140] = new ModelRendererTurbo(this, 0, 0, textureX, textureY);
      barrelModel[141] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[142] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[143] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[144] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[145] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[146] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[147] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[148] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[149] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[150] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[151] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[152] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[153] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[154] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[155] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[156] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[157] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[158] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[159] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[160] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[161] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[162] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[163] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[164] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[165] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[166] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[167] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[168] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[169] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[170] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[171] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[172] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[173] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[174] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[175] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[176] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[177] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[178] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[179] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[180] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[181] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[182] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[183] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[184] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[185] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[186] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[187] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[188] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[189] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[190] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[191] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[192] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[193] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[194] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[195] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[196] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[197] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[198] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[199] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      barrelModel[200] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
      ...
      barrelModel[5].addBox(7.0F, -2.0F, -2.0F, 2, 4, 4, 0.0F);
      barrelModel[5].setRotationPoint(17.0F, -35.0F, 0.0F);
      barrelModel[6].addBox(7.0F, -4.0F, -1.0F, 2, 2, 2, 0.0F);
      barrelModel[6].setRotationPoint(17.0F, -35.0F, 0.0F);
      barrelModel[7].addFlexBox(7.5F, -30.0F, -0.5F, 1, 27, 1, 0.0F, 10.0F, -10.0F, 0.0F, 0.0F, 4);
      barrelModel[7].setRotationPoint(17.0F, -35.0F, 0.0F);
      barrelModel[8].addBox(-2.5F, -1.5F, -3.0F, 24, 1, 6, 0.0F);
      barrelModel[8].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[9].addBox(22.5F, -0.5F, -3.0F, 1, 4, 6, 0.0F);
      barrelModel[9].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[10].addBox(-4.5F, -0.5F, -3.0F, 1, 4, 6, 0.0F);
      barrelModel[10].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[11].addBox(21.5F, -1.5F, -30.0F, 2, 1, 60, 0.0F);
      barrelModel[11].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[12].addBox(-4.5F, -1.5F, -30.0F, 2, 1, 60, 0.0F);
      barrelModel[12].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[13].addBox(-2.5F, -1.5F, 20.0F, 24, 1, 2, 0.0F);
      barrelModel[13].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[14].addBox(-2.5F, -1.5F, -22.0F, 24, 1, 2, 0.0F);
      barrelModel[14].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[15].addBox(21.5F, -11.5F, -29.7F, 2, 10, 1, 0.0F);
      barrelModel[15].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[16].addBox(-4.5F, -11.5F, -29.7F, 2, 10, 1, 0.0F);
      barrelModel[16].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[17].addBox(-4.5F, -11.5F, 28.7F, 2, 10, 1, 0.0F);
      barrelModel[17].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[18].addBox(21.5F, -11.5F, 28.7F, 2, 10, 1, 0.0F);
      barrelModel[18].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[19].addBox(-1.0F, -1.0F, 21.0F, 2, 2, 2, 0.0F);
      barrelModel[19].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[20].addBox(-1.0F, -1.0F, -23.0F, 2, 2, 2, 0.0F);
      barrelModel[20].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[21].addFlexBox(-10.5F, -5.5F, -28.7F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 5);
      barrelModel[21].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[22].addFlexBox(-10.5F, -5.5F, -25.5F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 5);
      barrelModel[22].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[23].addFlexBox(-10.5F, -5.5F, -22.3F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 5);
      barrelModel[23].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[24].addFlexBox(-10.5F, -5.5F, -19.1F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 5);
      barrelModel[24].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[25].addFlexBox(-10.5F, -5.5F, -15.9F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 5);
      barrelModel[25].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[26].addFlexBox(-10.5F, -5.5F, -12.7F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 5);
      barrelModel[26].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[27].addFlexBox(-10.5F, -5.5F, -9.5F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 5);
      barrelModel[27].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[28].addFlexBox(-10.5F, -5.5F, -6.3F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 5);
      barrelModel[28].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[29].addFlexBox(-10.5F, -5.5F, -3.1F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 5);
      barrelModel[29].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[30].addFlexBox(-10.5F, -5.5F, 0.1F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 5);
      barrelModel[30].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[31].addFlexBox(-10.5F, -5.5F, 3.3F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 5);
      barrelModel[31].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[32].addFlexBox(-10.5F, -5.5F, 6.5F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 5);
      barrelModel[32].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[33].addFlexBox(-10.5F, -5.5F, 9.7F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 5);
      barrelModel[33].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[34].addFlexBox(-10.5F, -5.5F, 12.9F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 5);
      barrelModel[34].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[35].addFlexBox(-10.5F, -5.5F, 16.1F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 5);
      barrelModel[35].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[36].addFlexBox(-10.5F, -5.5F, 19.3F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 5);
      barrelModel[36].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[37].addFlexBox(-10.5F, -5.5F, 22.5F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 5);
      barrelModel[37].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[38].addFlexBox(-10.5F, -5.5F, 25.7F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 5);
      barrelModel[38].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[39].addFlexBox(-10.5F, -2.5F, -28.7F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 5);
      barrelModel[39].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[40].addFlexBox(-10.5F, -2.5F, -25.5F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 5);
      barrelModel[40].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[41].addFlexBox(-10.5F, -2.5F, -22.3F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 5);
      barrelModel[41].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[42].addFlexBox(-10.5F, -2.5F, -19.1F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 5);
      barrelModel[42].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[43].addFlexBox(-10.5F, -2.5F, -15.9F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 5);
      barrelModel[43].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[44].addFlexBox(-10.5F, -2.5F, -12.7F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 5);
      barrelModel[44].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[45].addFlexBox(-10.5F, -2.5F, -9.5F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 5);
      barrelModel[45].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[46].addFlexBox(-10.5F, -2.5F, -6.3F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 5);
      barrelModel[46].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[47].addFlexBox(-10.5F, -2.5F, -3.1F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 5);
      barrelModel[47].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[48].addFlexBox(-10.5F, -2.5F, 0.1F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 5);
      barrelModel[48].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[49].addFlexBox(-10.5F, -2.5F, 3.3F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 5);
      barrelModel[49].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[50].addFlexBox(-10.5F, -2.5F, 6.5F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 5);
      barrelModel[50].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[51].addFlexBox(-10.5F, -2.5F, 9.7F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 5);
      barrelModel[51].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[52].addFlexBox(-10.5F, -2.5F, 12.9F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 5);
      barrelModel[52].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[53].addFlexBox(-10.5F, -2.5F, 16.1F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 5);
      barrelModel[53].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[54].addFlexBox(-10.5F, -2.5F, 19.3F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 5);
      barrelModel[54].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[55].addFlexBox(-10.5F, -2.5F, 22.5F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 5);
      barrelModel[55].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[56].addFlexBox(-10.5F, -2.5F, 25.7F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 5);
      barrelModel[56].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[57].addFlexBox(-10.5F, 1.5F, -22.3F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 5);
      barrelModel[57].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[58].addFlexBox(-10.5F, 1.5F, -19.1F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 5);
      barrelModel[58].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[59].addFlexBox(-10.5F, 1.5F, -15.9F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 5);
      barrelModel[59].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[60].addFlexBox(-10.5F, 1.5F, -12.7F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 5);
      barrelModel[60].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[61].addFlexBox(-10.5F, 1.5F, -9.5F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 5);
      barrelModel[61].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[62].addFlexBox(-10.5F, 1.5F, -6.3F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 5);
      barrelModel[62].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[63].addFlexBox(-10.5F, 1.5F, 3.3F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 5);
      barrelModel[63].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[64].addFlexBox(-10.5F, 1.5F, 6.5F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 5);
      barrelModel[64].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[65].addFlexBox(-10.5F, 1.5F, 9.7F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 5);
      barrelModel[65].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[66].addFlexBox(-10.5F, 1.5F, 12.9F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 5);
      barrelModel[66].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[67].addFlexBox(-10.5F, 1.5F, 16.1F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 5);
      barrelModel[67].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[68].addFlexBox(-10.5F, 1.5F, 19.3F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 5);
      barrelModel[68].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[69].addFlexBox(-10.5F, 4.5F, -22.3F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 5);
      barrelModel[69].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[70].addFlexBox(-10.5F, 4.5F, -19.1F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 5);
      barrelModel[70].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[71].addFlexBox(-10.5F, 4.5F, -15.9F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 5);
      barrelModel[71].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[72].addFlexBox(-10.5F, 4.5F, -12.7F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 5);
      barrelModel[72].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[73].addFlexBox(-10.5F, 4.5F, -9.5F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 5);
      barrelModel[73].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[74].addFlexBox(-10.5F, 4.5F, -6.3F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 5);
      barrelModel[74].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[75].addFlexBox(-10.5F, 4.5F, 3.3F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 5);
      barrelModel[75].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[76].addFlexBox(-10.5F, 4.5F, 6.5F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 5);
      barrelModel[76].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[77].addFlexBox(-10.5F, 4.5F, 9.7F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 5);
      barrelModel[77].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[78].addFlexBox(-10.5F, 4.5F, 12.9F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 5);
      barrelModel[78].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[79].addFlexBox(-10.5F, 4.5F, 16.1F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 5);
      barrelModel[79].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[80].addFlexBox(-10.5F, 4.5F, 19.3F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 5);
      barrelModel[80].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[81].addBox(-10.5F, -6.5F, -28.7F, 45, 1, 3, 0.0F);
      barrelModel[81].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[82].addBox(-10.5F, -6.5F, -25.5F, 45, 1, 3, 0.0F);
      barrelModel[82].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[83].addBox(-10.5F, -6.5F, -22.3F, 45, 1, 3, 0.0F);
      barrelModel[83].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[84].addBox(-10.5F, -6.5F, -19.1F, 45, 1, 3, 0.0F);
      barrelModel[84].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[85].addBox(-10.5F, -6.5F, -15.9F, 45, 1, 3, 0.0F);
      barrelModel[85].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[86].addBox(-10.5F, -6.5F, -12.7F, 45, 1, 3, 0.0F);
      barrelModel[86].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[87].addBox(-10.5F, -6.5F, -9.5F, 45, 1, 3, 0.0F);
      barrelModel[87].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[88].addBox(-10.5F, -6.5F, -6.3F, 45, 1, 3, 0.0F);
      barrelModel[88].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[89].addBox(-10.5F, -6.5F, -3.1F, 45, 1, 3, 0.0F);
      barrelModel[89].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[90].addBox(-10.5F, -6.5F, 0.1F, 45, 1, 3, 0.0F);
      barrelModel[90].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[91].addBox(-10.5F, -6.5F, 3.3F, 45, 1, 3, 0.0F);
      barrelModel[91].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[92].addBox(-10.5F, -6.5F, 6.5F, 45, 1, 3, 0.0F);
      barrelModel[92].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[93].addBox(-10.5F, -6.5F, 9.7F, 45, 1, 3, 0.0F);
      barrelModel[93].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[94].addBox(-10.5F, -6.5F, 12.9F, 45, 1, 3, 0.0F);
      barrelModel[94].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[95].addBox(-10.5F, -6.5F, 16.1F, 45, 1, 3, 0.0F);
      barrelModel[95].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[96].addBox(-10.5F, -6.5F, 19.3F, 45, 1, 3, 0.0F);
      barrelModel[96].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[97].addBox(-10.5F, -6.5F, 22.5F, 45, 1, 3, 0.0F);
      barrelModel[97].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[98].addBox(-10.5F, -6.5F, 25.7F, 45, 1, 3, 0.0F);
      barrelModel[98].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[99].addBox(-10.5F, -3.5F, -28.7F, 45, 1, 3, 0.0F);
      barrelModel[99].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[100].addBox(-10.5F, -3.5F, -25.5F, 45, 1, 3, 0.0F);
      barrelModel[100].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[101].addBox(-10.5F, -3.5F, -22.3F, 45, 1, 3, 0.0F);
      barrelModel[101].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[102].addBox(-10.5F, -3.5F, -19.1F, 45, 1, 3, 0.0F);
      barrelModel[102].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[103].addBox(-10.5F, -3.5F, -15.9F, 45, 1, 3, 0.0F);
      barrelModel[103].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[104].addBox(-10.5F, -3.5F, -12.7F, 45, 1, 3, 0.0F);
      barrelModel[104].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[105].addBox(-10.5F, -3.5F, -9.5F, 45, 1, 3, 0.0F);
      barrelModel[105].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[106].addBox(-10.5F, -3.5F, -6.3F, 45, 1, 3, 0.0F);
      barrelModel[106].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[107].addBox(-10.5F, -3.5F, -3.1F, 45, 1, 3, 0.0F);
      barrelModel[107].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[108].addBox(-10.5F, -3.5F, 0.1F, 45, 1, 3, 0.0F);
      barrelModel[108].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[109].addBox(-10.5F, -3.5F, 3.3F, 45, 1, 3, 0.0F);
      barrelModel[109].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[110].addBox(-10.5F, -3.5F, 6.5F, 45, 1, 3, 0.0F);
      barrelModel[110].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[111].addBox(-10.5F, -3.5F, 9.7F, 45, 1, 3, 0.0F);
      barrelModel[111].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[112].addBox(-10.5F, -3.5F, 12.9F, 45, 1, 3, 0.0F);
      barrelModel[112].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[113].addBox(-10.5F, -3.5F, 16.1F, 45, 1, 3, 0.0F);
      barrelModel[113].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[114].addBox(-10.5F, -3.5F, 19.3F, 45, 1, 3, 0.0F);
      barrelModel[114].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[115].addBox(-10.5F, -3.5F, 22.5F, 45, 1, 3, 0.0F);
      barrelModel[115].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[116].addBox(-10.5F, -3.5F, 25.7F, 45, 1, 3, 0.0F);
      barrelModel[116].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[117].addBox(-10.5F, 0.5F, -22.3F, 45, 1, 3, 0.0F);
      barrelModel[117].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[118].addBox(-10.5F, 0.5F, -19.1F, 45, 1, 3, 0.0F);
      barrelModel[118].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[119].addBox(-10.5F, 0.5F, -15.9F, 45, 1, 3, 0.0F);
      barrelModel[119].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[120].addBox(-10.5F, 0.5F, -12.7F, 45, 1, 3, 0.0F);
      barrelModel[120].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[121].addBox(-10.5F, 0.5F, -9.5F, 45, 1, 3, 0.0F);
      barrelModel[121].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[122].addBox(-10.5F, 0.5F, -6.3F, 45, 1, 3, 0.0F);
      barrelModel[122].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[123].addBox(-10.5F, 0.5F, 3.3F, 45, 1, 3, 0.0F);
      barrelModel[123].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[124].addBox(-10.5F, 0.5F, 6.5F, 45, 1, 3, 0.0F);
      barrelModel[124].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[125].addBox(-10.5F, 0.5F, 9.7F, 45, 1, 3, 0.0F);
      barrelModel[125].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[126].addBox(-10.5F, 0.5F, 12.9F, 45, 1, 3, 0.0F);
      barrelModel[126].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[127].addBox(-10.5F, 0.5F, 16.1F, 45, 1, 3, 0.0F);
      barrelModel[127].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[128].addBox(-10.5F, 0.5F, 19.3F, 45, 1, 3, 0.0F);
      barrelModel[128].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[129].addBox(-10.5F, 3.5F, -22.3F, 45, 1, 3, 0.0F);
      barrelModel[129].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[130].addBox(-10.5F, 3.5F, -19.1F, 45, 1, 3, 0.0F);
      barrelModel[130].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[131].addBox(-10.5F, 3.5F, -15.9F, 45, 1, 3, 0.0F);
      barrelModel[131].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[132].addBox(-10.5F, 3.5F, -12.7F, 45, 1, 3, 0.0F);
      barrelModel[132].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[133].addBox(-10.5F, 3.5F, -9.5F, 45, 1, 3, 0.0F);
      barrelModel[133].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[134].addBox(-10.5F, 3.5F, -6.3F, 45, 1, 3, 0.0F);
      barrelModel[134].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[135].addBox(-10.5F, 3.5F, 3.3F, 45, 1, 3, 0.0F);
      barrelModel[135].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[136].addBox(-10.5F, 3.5F, 6.5F, 45, 1, 3, 0.0F);
      barrelModel[136].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[137].addBox(-10.5F, 3.5F, 9.7F, 45, 1, 3, 0.0F);
      barrelModel[137].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[138].addBox(-10.5F, 3.5F, 12.9F, 45, 1, 3, 0.0F);
      barrelModel[138].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[139].addBox(-10.5F, 3.5F, 16.1F, 45, 1, 3, 0.0F);
      barrelModel[139].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[140].addBox(-10.5F, 3.5F, 19.3F, 45, 1, 3, 0.0F);
      barrelModel[140].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[141].addFlexBox(-10.5F, -7.5F, -28.7F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 4);
      barrelModel[141].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[142].addFlexBox(-10.5F, -7.5F, -25.5F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 4);
      barrelModel[142].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[143].addFlexBox(-10.5F, -7.5F, -22.3F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 4);
      barrelModel[143].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[144].addFlexBox(-10.5F, -7.5F, -19.1F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 4);
      barrelModel[144].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[145].addFlexBox(-10.5F, -7.5F, -15.9F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 4);
      barrelModel[145].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[146].addFlexBox(-10.5F, -7.5F, -12.7F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 4);
      barrelModel[146].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[147].addFlexBox(-10.5F, -7.5F, -9.5F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 4);
      barrelModel[147].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[148].addFlexBox(-10.5F, -7.5F, -3.1F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 4);
      barrelModel[148].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[149].addFlexBox(-10.5F, -7.5F, -6.3F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 4);
      barrelModel[149].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[150].addFlexBox(-10.5F, -7.5F, 0.1F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 4);
      barrelModel[150].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[151].addFlexBox(-10.5F, -7.5F, 3.3F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 4);
      barrelModel[151].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[152].addFlexBox(-10.5F, -7.5F, 6.5F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 4);
      barrelModel[152].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[153].addFlexBox(-10.5F, -7.5F, 9.7F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 4);
      barrelModel[153].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[154].addFlexBox(-10.5F, -7.5F, 12.9F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 4);
      barrelModel[154].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[155].addFlexBox(-10.5F, -7.5F, 16.1F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 4);
      barrelModel[155].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[156].addFlexBox(-10.5F, -7.5F, 19.3F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 4);
      barrelModel[156].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[157].addFlexBox(-10.5F, -7.5F, 22.5F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 4);
      barrelModel[157].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[158].addFlexBox(-10.5F, -7.5F, 25.7F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 4);
      barrelModel[158].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[159].addFlexBox(-10.5F, -4.5F, -28.7F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 4);
      barrelModel[159].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[160].addFlexBox(-10.5F, -4.5F, -25.5F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 4);
      barrelModel[160].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[161].addFlexBox(-10.5F, -4.5F, -22.3F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 4);
      barrelModel[161].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[162].addFlexBox(-10.5F, -4.5F, -19.1F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 4);
      barrelModel[162].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[163].addFlexBox(-10.5F, -4.5F, -15.9F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 4);
      barrelModel[163].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[164].addFlexBox(-10.5F, -4.5F, -12.7F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 4);
      barrelModel[164].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[165].addFlexBox(-10.5F, -4.5F, -9.5F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 4);
      barrelModel[165].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[166].addFlexBox(-10.5F, -4.5F, -6.3F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 4);
      barrelModel[166].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[167].addFlexBox(-10.5F, -4.5F, -3.1F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 4);
      barrelModel[167].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[168].addFlexBox(-10.5F, -4.5F, 0.1F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 4);
      barrelModel[168].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[169].addFlexBox(-10.5F, -4.5F, 3.3F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 4);
      barrelModel[169].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[170].addFlexBox(-10.5F, -4.5F, 6.5F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 4);
      barrelModel[170].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[171].addFlexBox(-10.5F, -4.5F, 9.7F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 4);
      barrelModel[171].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[172].addFlexBox(-10.5F, -4.5F, 12.9F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 4);
      barrelModel[172].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[173].addFlexBox(-10.5F, -4.5F, 16.1F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 4);
      barrelModel[173].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[174].addFlexBox(-10.5F, -4.5F, 19.3F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 4);
      barrelModel[174].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[175].addFlexBox(-10.5F, -4.5F, 22.5F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 4);
      barrelModel[175].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[176].addFlexBox(-10.5F, -4.5F, 25.7F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 4);
      barrelModel[176].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[177].addFlexBox(-10.5F, -0.5F, -22.3F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 4);
      barrelModel[177].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[178].addFlexBox(-10.5F, 2.5F, -22.3F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 4);
      barrelModel[178].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[179].addFlexBox(-10.5F, -0.5F, -19.1F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 4);
      barrelModel[179].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[180].addFlexBox(-10.5F, -0.5F, -15.9F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 4);
      barrelModel[180].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[181].addFlexBox(-10.5F, -0.5F, -12.7F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 4);
      barrelModel[181].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[182].addFlexBox(-10.5F, -0.5F, -9.5F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 4);
      barrelModel[182].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[183].addFlexBox(-10.5F, -0.5F, -6.3F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 4);
      barrelModel[183].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[184].addFlexBox(-10.5F, -0.5F, 3.3F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 4);
      barrelModel[184].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[185].addFlexBox(-10.5F, -0.5F, 6.5F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 4);
      barrelModel[185].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[186].addFlexBox(-10.5F, -0.5F, 9.7F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 4);
      barrelModel[186].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[187].addFlexBox(-10.5F, -0.5F, 12.9F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 4);
      barrelModel[187].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[188].addFlexBox(-10.5F, -0.5F, 16.1F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 4);
      barrelModel[188].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[189].addFlexBox(-10.5F, -0.5F, 19.3F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 4);
      barrelModel[189].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[190].addFlexBox(-10.5F, 2.5F, -19.1F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 4);
      barrelModel[190].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[191].addFlexBox(-10.5F, 2.5F, -15.9F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 4);
      barrelModel[191].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[192].addFlexBox(-10.5F, 2.5F, -12.7F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 4);
      barrelModel[192].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[193].addFlexBox(-10.5F, 2.5F, -9.5F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 4);
      barrelModel[193].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[194].addFlexBox(-10.5F, 2.5F, -6.3F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 4);
      barrelModel[194].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[195].addFlexBox(-10.5F, 2.5F, 3.3F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 4);
      barrelModel[195].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[196].addFlexBox(-10.5F, 2.5F, 6.5F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 4);
      barrelModel[196].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[197].addFlexBox(-10.5F, 2.5F, 9.7F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 4);
      barrelModel[197].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[198].addFlexBox(-10.5F, 2.5F, 12.9F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 4);
      barrelModel[198].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[199].addFlexBox(-10.5F, 2.5F, 16.1F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 4);
      barrelModel[199].setRotationPoint(-3.5F, -60.5F, 0.0F);
      barrelModel[200].addFlexBox(-10.5F, 2.5F, 19.3F, 45, 1, 3, 0.0F, 0.0F, 0.0F, -1.0F, -1.0F, 4);
      barrelModel[200].setRotationPoint(-3.5F, -60.5F, 0.0F);
      ...
      leftTrackModel[9].rotateAngleZ = (float) (-Math.PI / 4);
      ...
      leftTrackModel[12].rotateAngleZ = (float) (Math.PI / 4);
      ...
      rightTrackModel[9].rotateAngleZ = (float) (-Math.PI / 4);
      ...
      rightTrackModel[12].rotateAngleZ = (float) (Math.PI / 4);
