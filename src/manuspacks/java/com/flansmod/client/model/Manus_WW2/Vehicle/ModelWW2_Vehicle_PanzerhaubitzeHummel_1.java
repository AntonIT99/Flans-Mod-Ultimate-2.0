...
public class ModelWW2_Vehicle_PanzerhaubitzeHummel_1 extends ModelVehicle {
   int textureX = 512;
   int textureY = 512;
   ...
   public ModelWW2_Vehicle_PanzerhaubitzeHummel_1() {
      ...
      bodyModel[83].addShape3D(0.0F, 0.0F, 0.0F, new Shape2D(new Coord2D[]{new Coord2D(0.0, 13.0, 0, 13), new Coord2D(2.0, 4.0, 2, 4), new Coord2D(8.0, 0.0, 8, 0), new Coord2D(99.0, 0.0, 99, 0), new Coord2D(107.0, 1.0, 107, 1), new Coord2D(110.0, 13.0, 110, 13)}), 42.0F, 110, 13, 241, 42, 0, new float[]{110.0F, 13.0F, 9.0F, 91.0F, 8.0F, 10.0F});
      bodyModel[83].setRotationPoint(63.0F, 3.0F, 21.0F);
      bodyModel[84].addShape3D(0.0F, 0.0F, 0.0F, new Shape2D(new Coord2D[]{new Coord2D(0.0, 0.0, 0, 0), new Coord2D(127.0, 0.0, 127, 0), new Coord2D(117.0, 7.0, 117, 7), new Coord2D(7.0, 7.0, 7, 7), new Coord2D(4.0, 6.0, 4, 6)}), 1.0F, 127, 7, 262, 1, 0, new float[]{8.0F, 4.0F, 110.0F, 13.0F, 127.0F});
      bodyModel[84].setRotationPoint(67.0F, -8.0F, 21.0F);
      bodyModel[85].addShape3D(0.0F, 0.0F, 0.0F, new Shape2D(new Coord2D[]{new Coord2D(0.0, 0.0, 0, 0), new Coord2D(127.0, 0.0, 127, 0), new Coord2D(117.0, 7.0, 117, 7), new Coord2D(7.0, 7.0, 7, 7), new Coord2D(4.0, 6.0, 4, 6)}), 1.0F, 127, 7, 262, 1, 0, new float[]{8.0F, 4.0F, 110.0F, 13.0F, 127.0F});
      bodyModel[85].setRotationPoint(67.0F, -8.0F, -20.0F);
      bodyModel[86].addShape3D(0.0F, 0.0F, 0.0F, new Shape2D(new Coord2D[]{new Coord2D(0.0, 0.0, 0, 0), new Coord2D(15.0, 0.0, 15, 0), new Coord2D(15.0, 5.0, 15, 5)}), 40.0F, 15, 5, 36, 40, 0, new float[]{16.0F, 5.0F, 15.0F});
      bodyModel[86].setRotationPoint(63.0F, -10.0F, 20.0F);
      bodyModel[87].addShape3D(0.0F, 0.0F, 0.0F, new Shape2D(new Coord2D[]{new Coord2D(1.0, 0.0, 1, 0), new Coord2D(2.0, 5.0, 2, 5), new Coord2D(1.0, 5.0, 1, 5), new Coord2D(0.0, 0.0, 0, 0)}), 40.0F, 2, 5, 14, 40, 0, new float[]{1.0F, 6.0F, 1.0F, 6.0F});
      bodyModel[87].setRotationPoint(-46.0F, -10.0F, 20.0F);
      bodyModel[88].addShape3D(0.0F, 0.0F, 0.0F, new Shape2D(new Coord2D[]{new Coord2D(0.0, 0.0, 0, 0), new Coord2D(1.0, 0.0, 1, 0), new Coord2D(4.0, 5.0, 4, 5), new Coord2D(4.0, 6.0, 4, 6)}), 10.0F, 4, 6, 16, 10, 0, new float[]{8.0F, 1.0F, 6.0F, 1.0F});
      bodyModel[88].setRotationPoint(67.0F, -8.0F, 31.0F);
      bodyModel[89].addShape3D(0.0F, 0.0F, 0.0F, new Shape2D(new Coord2D[]{new Coord2D(0.0, 0.0, 0, 0), new Coord2D(1.0, 0.0, 1, 0), new Coord2D(4.0, 5.0, 4, 5), new Coord2D(4.0, 6.0, 4, 6)}), 10.0F, 4, 6, 16, 10, 0, new float[]{8.0F, 1.0F, 6.0F, 1.0F});
      bodyModel[89].setRotationPoint(67.0F, -8.0F, -21.0F);
      bodyModel[90].addShape3D(0.0F, 0.0F, 0.0F, new Shape2D(new Coord2D[]{new Coord2D(0.0, 1.0, 0, 1), new Coord2D(0.0, 0.0, 0, 0), new Coord2D(3.0, 1.0, 3, 1), new Coord2D(3.0, 2.0, 3, 2)}), 10.0F, 3, 2, 10, 10, 0, new float[]{4.0F, 1.0F, 4.0F, 1.0F});
      bodyModel[90].setRotationPoint(63.0F, -13.0F, 31.0F);
      bodyModel[91].addShape3D(0.0F, 0.0F, 0.0F, new Shape2D(new Coord2D[]{new Coord2D(0.0, 1.0, 0, 1), new Coord2D(0.0, 0.0, 0, 0), new Coord2D(3.0, 1.0, 3, 1), new Coord2D(3.0, 2.0, 3, 2)}), 10.0F, 3, 2, 10, 10, 0, new float[]{4.0F, 1.0F, 4.0F, 1.0F});
      bodyModel[91].setRotationPoint(63.0F, -13.0F, -21.0F);
      bodyModel[92].addShape3D(0.0F, 0.0F, 0.0F, new Shape2D(new Coord2D[]{new Coord2D(9.0, 0.0, 9, 0), new Coord2D(10.0, 0.0, 10, 0), new Coord2D(0.0, 7.0, 0, 7), new Coord2D(0.0, 6.0, 0, 6)}), 10.0F, 10, 7, 26, 10, 0, new float[]{11.0F, 1.0F, 13.0F, 1.0F});
      bodyModel[92].setRotationPoint(-50.0F, -8.0F, 31.0F);
      bodyModel[93].addShape3D(0.0F, 0.0F, 0.0F, new Shape2D(new Coord2D[]{new Coord2D(9.0, 0.0, 9, 0), new Coord2D(10.0, 0.0, 10, 0), new Coord2D(0.0, 7.0, 0, 7), new Coord2D(0.0, 6.0, 0, 6)}), 10.0F, 10, 7, 26, 10, 0, new float[]{11.0F, 1.0F, 13.0F, 1.0F});
      ...
      bodyModel[143].addShape3D(0.0F, 0.0F, 0.0F, new Shape2D(new Coord2D[]{new Coord2D(0.0, 2.0, 0, 2), new Coord2D(3.0, 0.0, 3, 0), new Coord2D(3.0, 1.0, 3, 1), new Coord2D(1.0, 2.0, 1, 2)}), 1.0F, 3, 2, 9, 1, 0, new float[]{1.0F, 3.0F, 1.0F, 4.0F});
      bodyModel[143].rotateAngleX = (float) (Math.PI / 2);
      bodyModel[143].setRotationPoint(6.0F, -43.0F, 22.0F);
      bodyModel[144].addShape3D(0.0F, 0.0F, 0.0F, new Shape2D(new Coord2D[]{new Coord2D(0.0, 2.0, 0, 2), new Coord2D(3.0, 0.0, 3, 0), new Coord2D(3.0, 1.0, 3, 1), new Coord2D(1.0, 2.0, 1, 2)}), 1.0F, 3, 2, 9, 1, 0, new float[]{1.0F, 3.0F, 1.0F, 4.0F});
