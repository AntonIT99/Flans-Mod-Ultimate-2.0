...
public class ModelWW2_Vehicle_SU100_1 extends ModelVehicle {
   int textureX = 512;
   int textureY = 512;

   public ModelWW2_Vehicle_SU100_1() {
      ...
      bodyModel[38].addShape3D(0.0F, 0.0F, 0.0F, new Shape2D(new Coord2D[]{new Coord2D(0.0, 7.0, 0, 7), new Coord2D(9.0, 0.0, 9, 0), new Coord2D(105.0, 0.0, 105, 0), new Coord2D(112.0, 7.0, 112, 7)}), 36.0F, 112, 7, 230, 36, 0, new float[]{112.0F, 10.0F, 95.0F, 13.0F});
      bodyModel[38].setRotationPoint(44.0F, 2.0F, 18.0F);
      bodyModel[39].addShape3D(0.0F, 0.0F, 0.0F, new Shape2D(new Coord2D[]{new Coord2D(0.0, 0.0, 0, 0), new Coord2D(112.0, 0.0, 112, 0), new Coord2D(115.0, 3.0, 115, 3), new Coord2D(108.0, 8.0, 108, 8), new Coord2D(10.0, 8.0, 10, 8)}), 36.0F, 115, 8, 237, 36, 0, new float[]{16.0F, 95.0F, 9.0F, 5.0F, 112.0F});
      ...
      bodyModel[41].addShape3D(0.0F, 0.0F, 0.0F, new Shape2D(new Coord2D[]{new Coord2D(0.0, 0.0, 0, 0), new Coord2D(13.0, 0.0, 13, 0), new Coord2D(13.0, 8.0, 13, 8), new Coord2D(1.0, 8.0, 1, 8)}), 1.0F, 13, 8, 42, 1, 0, new float[]{9.0F, 12.0F, 8.0F, 13.0F});
      ...
      bodyModel[43].addShape3D(0.0F, 0.0F, 0.0F, new Shape2D(new Coord2D[]{new Coord2D(0.0, 2.0, 0, 2), new Coord2D(9.0, 0.0, 9, 0), new Coord2D(9.0, 1.0, 9, 1), new Coord2D(0.0, 3.0, 0, 3)}), 12.0F, 9, 3, 22, 12, 0, new float[]{1.0F, 10.0F, 1.0F, 10.0F});
      ...
      bodyModel[45].addShape3D(0.0F, 0.0F, 0.0F, new Shape2D(new Coord2D[]{new Coord2D(0.0, 1.0, 0, 1), new Coord2D(0.0, 0.0, 0, 0), new Coord2D(3.0, 1.0, 3, 1), new Coord2D(3.0, 2.0, 3, 2)}), 12.0F, 3, 2, 10, 12, 0, new float[]{4.0F, 1.0F, 4.0F, 1.0F});
      ...
      bodyModel[47].addShape3D(0.0F, 0.0F, 0.0F, new Shape2D(new Coord2D[]{new Coord2D(0.0, 0.0, 0, 0), new Coord2D(1.0, 0.0, 1, 0), new Coord2D(4.0, 5.0, 4, 5), new Coord2D(4.0, 6.0, 4, 6), new Coord2D(3.0, 5.0, 3, 5)}), 12.0F, 4, 6, 16, 12, 0, new float[]{6.0F, 2.0F, 1.0F, 6.0F, 1.0F});
      ...
      bodyModel[49].addShape3D(0.0F, 0.0F, 0.0F, new Shape2D(new Coord2D[]{new Coord2D(0.0, 1.0, 0, 1), new Coord2D(6.0, 0.0, 6, 0), new Coord2D(7.0, 8.0, 7, 8), new Coord2D(4.0, 7.0, 4, 7), new Coord2D(3.0, 6.0, 3, 6)}), 1.0F, 7, 8, 28, 1, 0, new float[]{6.0F, 2.0F, 4.0F, 9.0F, 7.0F});
      ...
      bodyModel[51].addShape3D(0.0F, 0.0F, 0.0F, new Shape2D(new Coord2D[]{new Coord2D(7.0, 0.0, 7, 0), new Coord2D(9.0, 2.0, 9, 2), new Coord2D(9.0, 3.0, 9, 3), new Coord2D(0.0, 5.0, 0, 5)}), 1.0F, 9, 5, 23, 1, 0, new float[]{9.0F, 10.0F, 1.0F, 3.0F});
      ...
      barrelModel[2].addTrapezoid(-14.0F, -2.5F, -2.5F, 27, 5, 5, 0.0F, -0.3F, 2);
      barrelModel[2].setRotationPoint(33.0F, -22.0F, -5.0F);
      barrelModel[3].addTrapezoid(13.0F, -2.0F, -2.0F, 70, 4, 4, 0.0F, -0.5F, 2);
