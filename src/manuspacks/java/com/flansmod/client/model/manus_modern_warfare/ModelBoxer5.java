...
public class ModelBoxer5 extends ModelVehicle {
   ...
   public ModelBoxer5() {
      ...
      bodyModel[16].addShape3D(0.0F, 0.0F, 0.0F, new Shape2D(new Coord2D[]{new Coord2D(16.0, 0.0, 16, 0), new Coord2D(16.0, 16.0, 16, 16), new Coord2D(0.0, 16.0, 0, 16)}), 34.0F, 16, 16, 55, 34, 0, new float[]{23.0F, 16.0F, 16.0F});
      bodyModel[16].setRotationPoint(74.0F, 0.0F, 17.0F);
      bodyModel[17].addShape3D(0.0F, 0.0F, 0.0F, new Shape2D(new Coord2D[]{new Coord2D(0.0, 0.0, 0, 0), new Coord2D(9.0, 0.0, 9, 0), new Coord2D(6.0, 14.0, 6, 14), new Coord2D(0.0, 14.0, 0, 14)}), 83.0F, 9, 14, 44, 83, 0, new float[]{14.0F, 6.0F, 15.0F, 9.0F});
      bodyModel[17].rotateAngleY = (float) (-Math.PI / 2);
      bodyModel[17].setRotationPoint(28.0F, -17.0F, 15.0F);
      bodyModel[18].addShape3D(0.0F, 0.0F, 0.0F, new Shape2D(new Coord2D[]{new Coord2D(0.0, 0.0, 0, 0), new Coord2D(9.0, 0.0, 9, 0), new Coord2D(6.0, 14.0, 6, 14), new Coord2D(0.0, 14.0, 0, 14)}), 83.0F, 9, 14, 44, 83, 0, new float[]{14.0F, 6.0F, 15.0F, 9.0F});
      bodyModel[18].rotateAngleY = (float) (Math.PI / 2);
      bodyModel[18].setRotationPoint(-55.0F, -17.0F, -15.0F);
      bodyModel[19].addShape3D(0.0F, 0.0F, 0.0F, new Shape2D(new Coord2D[]{new Coord2D(0.0, 0.0, 0, 0), new Coord2D(48.0, 0.0, 48, 0), new Coord2D(45.0, 48.0, 45, 48), new Coord2D(3.0, 48.0, 3, 48)}), 1.0F, 48, 48, 188, 1, 0, new float[]{49.0F, 42.0F, 49.0F, 48.0F});
      bodyModel[19].rotateAngleY = (float) (-Math.PI / 2);
      bodyModel[19].rotateAngleX = 1.2740903F;
      bodyModel[19].setRotationPoint(74.0F, -17.0F, -24.0F);
      bodyModel[20].addShape3D(0.0F, 0.0F, 0.0F, new Shape2D(new Coord2D[]{new Coord2D(0.0, 0.0, 0, 0), new Coord2D(46.0, 0.0, 46, 0), new Coord2D(46.0, 14.0, 46, 14)}), 1.0F, 46, 14, 109, 1, 0, new float[]{49.0F, 14.0F, 46.0F});
      bodyModel[20].rotateAngleX = (float) (Math.PI / 15);
      bodyModel[20].setRotationPoint(74.0F, -17.0F, 24.0F);
      bodyModel[21].addShape3D(0.0F, 0.0F, -1.0F, new Shape2D(new Coord2D[]{new Coord2D(0.0, 0.0, 0, 0), new Coord2D(46.0, 0.0, 46, 0), new Coord2D(46.0, 14.0, 46, 14)}), 1.0F, 46, 14, 109, 1, 0, new float[]{49.0F, 14.0F, 46.0F});
      bodyModel[21].rotateAngleX = (float) (-Math.PI / 15);
      bodyModel[21].setRotationPoint(74.0F, -17.0F, -24.0F);
      bodyModel[22].addShape3D(0.0F, 0.0F, 0.0F, new Shape2D(new Coord2D[]{new Coord2D(0.0, 7.0, 0, 7), new Coord2D(7.0, 0.0, 7, 0), new Coord2D(14.0, 0.0, 14, 0), new Coord2D(20.0, 7.0, 20, 7)}), 7.0F, 20, 7, 47, 7, 0, new float[]{20.0F, 10.0F, 7.0F, 10.0F});
      bodyModel[22].setRotationPoint(74.0F, -9.0F, 24.0F);
      bodyModel[23].addShape3D(0.0F, 0.0F, 0.0F, new Shape2D(new Coord2D[]{new Coord2D(0.0, 7.0, 0, 7), new Coord2D(7.0, 0.0, 7, 0), new Coord2D(13.0, 0.0, 13, 0), new Coord2D(20.0, 7.0, 20, 7)}), 7.0F, 20, 7, 46, 7, 0, new float[]{20.0F, 10.0F, 6.0F, 10.0F});
      bodyModel[23].setRotationPoint(45.0F, -9.0F, 24.0F);
      bodyModel[24].addShape3D(0.0F, 0.0F, 0.0F, new Shape2D(new Coord2D[]{new Coord2D(0.0, 7.0, 0, 7), new Coord2D(7.0, 0.0, 7, 0), new Coord2D(13.0, 0.0, 13, 0), new Coord2D(20.0, 7.0, 20, 7)}), 7.0F, 20, 7, 46, 7, 0, new float[]{20.0F, 10.0F, 6.0F, 10.0F});
      bodyModel[24].setRotationPoint(15.0F, -9.0F, 24.0F);
      bodyModel[25].addShape3D(0.0F, 0.0F, 0.0F, new Shape2D(new Coord2D[]{new Coord2D(0.0, 7.0, 0, 7), new Coord2D(7.0, 0.0, 7, 0), new Coord2D(13.0, 0.0, 13, 0), new Coord2D(20.0, 7.0, 20, 7)}), 7.0F, 20, 7, 46, 7, 0, new float[]{20.0F, 10.0F, 6.0F, 10.0F});
      bodyModel[25].setRotationPoint(-14.0F, -9.0F, 24.0F);
      bodyModel[26].addShape3D(0.0F, 0.0F, 0.0F, new Shape2D(new Coord2D[]{new Coord2D(0.0, 7.0, 0, 7), new Coord2D(7.0, 0.0, 7, 0), new Coord2D(9.0, 0.0, 9, 0), new Coord2D(10.0, 7.0, 10, 7)}), 9.0F, 10, 7, 30, 9, 0, new float[]{10.0F, 8.0F, 2.0F, 10.0F});
      ...
      bodyModel[29].addShape3D(0.0F, 0.0F, 0.0F, new Shape2D(new Coord2D[]{new Coord2D(0.0, 7.0, 0, 7), new Coord2D(7.0, 0.0, 7, 0), new Coord2D(14.0, 0.0, 14, 0), new Coord2D(20.0, 7.0, 20, 7)}), 7.0F, 20, 7, 47, 7, 0, new float[]{20.0F, 10.0F, 7.0F, 10.0F});
      bodyModel[29].setRotationPoint(74.0F, -9.0F, -17.0F);
      bodyModel[30].addShape3D(0.0F, 0.0F, 0.0F, new Shape2D(new Coord2D[]{new Coord2D(0.0, 7.0, 0, 7), new Coord2D(7.0, 0.0, 7, 0), new Coord2D(13.0, 0.0, 13, 0), new Coord2D(20.0, 7.0, 20, 7)}), 7.0F, 20, 7, 46, 7, 0, new float[]{20.0F, 10.0F, 6.0F, 10.0F});
      bodyModel[30].setRotationPoint(45.0F, -9.0F, -17.0F);
      bodyModel[31].addShape3D(0.0F, 0.0F, 0.0F, new Shape2D(new Coord2D[]{new Coord2D(0.0, 7.0, 0, 7), new Coord2D(7.0, 0.0, 7, 0), new Coord2D(13.0, 0.0, 13, 0), new Coord2D(20.0, 7.0, 20, 7)}), 7.0F, 20, 7, 46, 7, 0, new float[]{20.0F, 10.0F, 6.0F, 10.0F});
      bodyModel[31].setRotationPoint(15.0F, -9.0F, -17.0F);
      bodyModel[32].addShape3D(0.0F, 0.0F, 0.0F, new Shape2D(new Coord2D[]{new Coord2D(0.0, 7.0, 0, 7), new Coord2D(7.0, 0.0, 7, 0), new Coord2D(13.0, 0.0, 13, 0), new Coord2D(20.0, 7.0, 20, 7)}), 7.0F, 20, 7, 46, 7, 0, new float[]{20.0F, 10.0F, 6.0F, 10.0F});
      bodyModel[32].setRotationPoint(-14.0F, -9.0F, -17.0F);
      bodyModel[33].addShape3D(0.0F, 0.0F, 0.0F, new Shape2D(new Coord2D[]{new Coord2D(0.0, 7.0, 0, 7), new Coord2D(7.0, 0.0, 7, 0), new Coord2D(9.0, 0.0, 9, 0), new Coord2D(10.0, 7.0, 10, 7)}), 9.0F, 10, 7, 30, 9, 0, new float[]{10.0F, 8.0F, 2.0F, 10.0F});
      ...
      bodyModel[59].rotateAngleX = (float) (Math.PI / 12);
      ...
      bodyModel[60].rotateAngleX = (float) (Math.PI / 12);
      ...
      bodyModel[82].rotateAngleY = (float) Math.PI;
      ...
      bodyModel[86].rotateAngleY = (float) Math.PI;
      ...
      bodyModel[88].rotateAngleY = (float) Math.PI;
      ...
      bodyModel[90].rotateAngleY = (float) Math.PI;
      ...
      turretModel = new ModelRendererTurbo[13];
      turretModel[0] = new ModelRendererTurbo(this, 290, 0, textureX, textureY);
      turretModel[1] = new ModelRendererTurbo(this, 290, 25, textureX, textureY);
      turretModel[2] = new ModelRendererTurbo(this, 350, 0, textureX, textureY);
      turretModel[3] = new ModelRendererTurbo(this, 290, 25, textureX, textureY);
      turretModel[4] = new ModelRendererTurbo(this, 290, 40, textureX, textureY);
      turretModel[5] = new ModelRendererTurbo(this, 290, 45, textureX, textureY);
      turretModel[6] = new ModelRendererTurbo(this, 395, 25, textureX, textureY);
      turretModel[7] = new ModelRendererTurbo(this, 395, 35, textureX, textureY);
      turretModel[8] = new ModelRendererTurbo(this, 395, 40, textureX, textureY);
      turretModel[9] = new ModelRendererTurbo(this, 425, 0, textureX, textureY);
      turretModel[10] = new ModelRendererTurbo(this, 425, 30, textureX, textureY);
      turretModel[11] = new ModelRendererTurbo(this, 0, 90, textureX, textureY);
      turretModel[12] = new ModelRendererTurbo(this, 0, 115, textureX, textureY);
      turretModel[0].addBox(-9.0F, -32.0F, -9.0F, 18, 1, 18, 0.0F);
      turretModel[1].addTrapezoid(-20.0F, -39.0F, -16.0F, 34, 7, 32, 0.0F, -4.0F, 5);
      turretModel[2].addBox(-20.0F, -47.0F, -4.0F, 20, 8, 8, 0.0F);
      turretModel[3].addBox(0.0F, 0.0F, 0.0F, 9, 3, 6, 0.0F);
      turretModel[3].setRotationPoint(-20.0F, -45.0F, -3.0F);
      turretModel[3].rotateAngleZ = 1.902409F;
      turretModel[4].addBox(0.0F, 0.0F, 0.0F, 3, 2, 2, 0.0F);
      turretModel[4].setRotationPoint(-20.0F, -48.0F, 3.0F);
      turretModel[4].rotateAngleZ = 1.902409F;
      turretModel[5].addBox(0.0F, 0.0F, 0.0F, 3, 6, 3, 0.0F);
      turretModel[5].setRotationPoint(-20.0F, -48.0F, 5.0F);
      turretModel[5].rotateAngleZ = 1.902409F;
      turretModel[6].addBox(0.0F, 0.0F, 0.0F, 5, 1, 5, 0.0F);
      turretModel[6].setRotationPoint(-16.0F, -48.3F, 4.0F);
      turretModel[6].rotateAngleZ = 1.902409F;
      turretModel[7].addBox(0.0F, 0.0F, 0.0F, 3, 2, 1, 0.0F);
      turretModel[7].setRotationPoint(-20.0F, -48.0F, -4.0F);
      turretModel[7].rotateAngleZ = 1.902409F;
      turretModel[8].addBox(0.0F, 0.0F, 0.0F, 6, 5, 5, 0.0F);
      turretModel[8].setRotationPoint(-20.0F, -46.0F, -9.0F);
      turretModel[8].rotateAngleZ = 1.902409F;
      turretModel[9].addBox(0.0F, 0.0F, 0.0F, 6, 3, 22, 0.0F);
      turretModel[9].setRotationPoint(-22.0F, -59.0F, 11.0F);
      turretModel[9].rotateAngleY = (float) Math.PI;
      turretModel[9].rotateAngleZ = -1.727876F;
      turretModel[10].addBox(0.0F, 0.0F, 0.0F, 6, 3, 22, 0.0F);
      turretModel[10].setRotationPoint(-22.0F, -59.0F, -11.0F);
      turretModel[10].rotateAngleZ = 1.413717F;
      turretModel[11].addShape3D(0.0F, 0.0F, 0.0F, new Shape2D(new Coord2D[]{new Coord2D(0.0, 0.0, 0, 0), new Coord2D(34.0, 0.0, 34, 0), new Coord2D(34.0, 6.0, 34, 6), new Coord2D(32.0, 8.0, 32, 8), new Coord2D(14.0, 8.0, 14, 8)}), 12.0F, 34, 8, 78, 12, 0, new float[]{17.0F, 18.0F, 3.0F, 6.0F, 34.0F});
      turretModel[11].setRotationPoint(14.0F, -39.0F, 16.0F);
      turretModel[12].addShape3D(0.0F, 0.0F, 0.0F, new Shape2D(new Coord2D[]{new Coord2D(0.0, 0.0, 0, 0), new Coord2D(34.0, 0.0, 34, 0), new Coord2D(34.0, 6.0, 34, 6), new Coord2D(32.0, 8.0, 32, 8), new Coord2D(14.0, 8.0, 14, 8)}), 12.0F, 34, 8, 78, 12, 0, new float[]{17.0F, 18.0F, 3.0F, 6.0F, 34.0F});
      turretModel[12].setRotationPoint(14.0F, -39.0F, -4.0F);
      barrelModel = new ModelRendererTurbo[4];
      barrelModel[0] = new ModelRendererTurbo(this, 290, 70, textureX, textureY);
      barrelModel[1] = new ModelRendererTurbo(this, 360, 70, textureX, textureY);
      barrelModel[2] = new ModelRendererTurbo(this, 425, 70, textureX, textureY);
      barrelModel[3] = new ModelRendererTurbo(this, 425, 60, textureX, textureY);
      barrelModel[0].addBox(0.0F, -4.0F, -4.0F, 20, 8, 8, 0.0F);
      barrelModel[0].setRotationPoint(0.0F, -43.0F, 0.0F);
      barrelModel[1].addTrapezoid(20.0F, -4.0F, -4.0F, 25, 8, 8, 0.0F, -2.5F, 2);
      barrelModel[1].setRotationPoint(0.0F, -43.0F, 0.0F);
      barrelModel[2].addBox(24.0F, -1.0F, -1.0F, 28, 2, 2, 0.0F);
      barrelModel[2].setRotationPoint(0.0F, -43.0F, 0.0F);
      barrelModel[3].addBox(52.0F, -1.5F, -1.5F, 4, 3, 3, 0.0F);
      barrelModel[3].setRotationPoint(0.0F, -43.0F, 0.0F);
      translateAll(0, 0, 0);
      flipAll();
   }
}
