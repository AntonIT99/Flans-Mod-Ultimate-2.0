...
public class ModelBoxer4 extends ModelVehicle {
   int textureX = 512;
   int textureY = 512;
   ...
   public ModelBoxer4() {
      ...
      turretModel[0] = new ModelRendererTurbo(this, 130, 0, textureX, textureY);
      turretModel[1] = new ModelRendererTurbo(this, 130, 25, textureX, textureY);
      turretModel[2] = new ModelRendererTurbo(this, 130, 70, textureX, textureY);
      turretModel[3] = new ModelRendererTurbo(this, 195, 70, textureX, textureY);
      turretModel[4] = new ModelRendererTurbo(this, 205, 25, textureX, textureY);
      turretModel[5] = new ModelRendererTurbo(this, 195, 0, textureX, textureY);
      turretModel[6] = new ModelRendererTurbo(this, 215, 15, textureX, textureY);
      turretModel[0].addBox(-10.0F, -32.0F, -10.0F, 20, 1, 20, 0.0F);
      turretModel[1].addBox(-13.0F, -46.0F, -13.0F, 23, 14, 26, 0.0F);
      turretModel[2].addTrapezoid(-17.0F, -46.0F, -13.0F, 4, 12, 26, 0.0F, -1.0F, 3);
      turretModel[3].addTrapezoid(10.0F, -46.0F, -5.0F, 3, 13, 18, 0.0F, -1.0F, 2);
      turretModel[4].addTrapezoid(13.0F, -44.0F, -4.0F, 3, 7, 15, 0.0F, -1.5F, 2);
      turretModel[5].addBox(-8.0F, -50.0F, -3.0F, 6, 4, 6, 0.0F);
      turretModel[6].addBox(7.0F, -42.0F, -14.0F, 5, 5, 2, 0.0F);
      barrelModel = new ModelRendererTurbo[5];
      barrelModel[0] = new ModelRendererTurbo(this, 245, 0, textureX, textureY);
      barrelModel[1] = new ModelRendererTurbo(this, 245, 20, textureX, textureY);
      barrelModel[2] = new ModelRendererTurbo(this, 235, 33, textureX, textureY);
      barrelModel[3] = new ModelRendererTurbo(this, 245, 40, textureX, textureY);
      barrelModel[4] = new ModelRendererTurbo(this, 245, 50, textureX, textureY);
      barrelModel[0].addTrapezoid(-3.0F, -3.0F, -4.0F, 13, 6, 8, 0.0F, -0.5F, 2);
      barrelModel[0].setRotationPoint(10.0F, -39.5F, -9.0F);
      barrelModel[1].addTrapezoid(10.0F, -2.5F, -1.5F, 15, 5, 5, 0.0F, -1.4F, 2);
      barrelModel[1].setRotationPoint(10.0F, -39.5F, -9.0F);
      barrelModel[2].addBox(10.0F, -1.0F, 0.0F, 23, 2, 2, 0.0F);
      barrelModel[2].setRotationPoint(10.0F, -39.5F, -9.0F);
      barrelModel[3].addBox(33.0F, -1.5F, -0.5F, 5, 3, 3, 0.0F);
      barrelModel[3].setRotationPoint(10.0F, -39.5F, -9.0F);
      barrelModel[4].addTrapezoid(10.0F, -1.5F, -3.5F, 7, 3, 2, 0.0F, -0.5F, 2);
      barrelModel[4].setRotationPoint(10.0F, -39.5F, -9.0F);
      translateAll(0, 0, 0);
      flipAll();
   }
}
