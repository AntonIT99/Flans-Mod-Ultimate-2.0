...
public class ModelBwTruck extends ModelVehicle {
   ...
   public ModelBwTruck() {
      ...
      bodyModel[94].addShape3D(0.0F, 0.0F, 0.0F, new Shape2D(new Coord2D[]{new Coord2D(0.0, 0.0, 0, 0), new Coord2D(5.0, 0.0, 5, 0), new Coord2D(11.0, 15.0, 11, 15), new Coord2D(11.0, 17.0, 11, 17), new Coord2D(8.0, 17.0, 8, 17), new Coord2D(5.0, 14.0, 5, 14)}), 1.0F, 11, 17, 47, 1, 0, new float[]{15.0F, 5.0F, 3.0F, 2.0F, 17.0F, 5.0F});
      bodyModel[94].setRotationPoint(45.0F, -22.0F, -17.0F);
      bodyModel[95].addShape3D(0.0F, 0.0F, 0.0F, new Shape2D(new Coord2D[]{new Coord2D(0.0, 0.0, 0, 0), new Coord2D(5.0, 0.0, 5, 0), new Coord2D(11.0, 15.0, 11, 15), new Coord2D(11.0, 17.0, 11, 17), new Coord2D(8.0, 17.0, 8, 17), new Coord2D(5.0, 14.0, 5, 14)}), 1.0F, 11, 17, 47, 1, 0, new float[]{15.0F, 5.0F, 3.0F, 2.0F, 17.0F, 5.0F});
      bodyModel[95].setRotationPoint(45.0F, -22.0F, 18.0F);
      bodyModel[96].addShape3D(0.0F, 0.0F, 0.0F, new Shape2D(new Coord2D[]{new Coord2D(0.0, 0.0, 0, 0), new Coord2D(6.0, 1.0, 6, 1), new Coord2D(6.0, 3.0, 6, 3), new Coord2D(3.0, 3.0, 3, 3)}), 34.0F, 6, 3, 17, 34, 0, new float[]{5.0F, 3.0F, 2.0F, 7.0F});
