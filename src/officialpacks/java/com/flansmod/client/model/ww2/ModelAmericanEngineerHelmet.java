...
public class ModelAmericanEngineerHelmet extends ModelCustomArmour {
   int textureX = 256;
   int textureY = 256;

   public ModelAmericanEngineerHelmet() {
      ...
      this.headModel[10] = new ModelRendererTurbo(this, 36, 87, this.textureX, this.textureY);
      this.headModel[11] = new ModelRendererTurbo(this, 36, 87, this.textureX, this.textureY);
      this.headModel[12] = new ModelRendererTurbo(this, 0, 87, this.textureX, this.textureY);
      this.headModel[13] = new ModelRendererTurbo(this, 0, 87, this.textureX, this.textureY);
      ...
      this.headModel[10].addBox(-3.3F, -8.5F, -5.2F, 3, 2, 1, 0.0F);
      this.headModel[10].setRotationPoint(0.0F, 0.0F, 0.0F);
      this.headModel[11].addBox(0.3F, -8.5F, -5.2F, 3, 2, 1, 0.0F);
      this.headModel[11].setRotationPoint(0.0F, 0.0F, 0.0F);
      this.headModel[12].addShapeBox(-0.5F, -8.5F, -5.2F, 1, 2, 1, 0.0F, -0.2F, 0.0F, 0.0F, -0.2F, 0.0F, 0.0F, -0.2F, 0.0F, 0.0F, -0.2F, 0.0F, 0.0F, -0.2F, -0.5F, 0.0F, -0.2F, -0.5F, 0.0F, -0.2F, -0.5F, 0.0F, -0.2F, -0.5F, 0.0F);
      this.headModel[12].setRotationPoint(0.0F, 0.0F, 0.0F);
      this.headModel[13].addShapeBox(-5.0F, -8.0F, -5.0F, 10, 1, 10, 0.0F, -0.5F, 0.0F, -0.5F, -0.5F, 0.0F, -0.5F, -0.5F, -1.0F, -0.5F, -0.5F, -1.0F, -0.5F, -0.5F, 0.0F, -0.5F, -0.5F, 0.0F, -0.5F, -0.5F, 1.0F, -0.5F, -0.5F, 1.0F, -0.5F);
