...
public class ModelAmericanOfficerHelmet extends ModelCustomArmour {
   ...
   public ModelAmericanOfficerHelmet() {
      ...
      this.headModel[10] = new ModelRendererTurbo(this, 60, 99, this.textureX, this.textureY);
      this.headModel[11] = new ModelRendererTurbo(this, 41, 81, this.textureX, this.textureY);
