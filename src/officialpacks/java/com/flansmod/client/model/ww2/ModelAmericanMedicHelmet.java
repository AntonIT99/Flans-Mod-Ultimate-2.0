...
public class ModelAmericanMedicHelmet extends ModelCustomArmour {
   int textureX = 256;
   int textureY = 256;

   public ModelAmericanMedicHelmet() {
      ...
      this.headModel[10] = new ModelRendererTurbo(this, 70, 93, this.textureX, this.textureY);
      this.headModel[11] = new ModelRendererTurbo(this, 70, 93, this.textureX, this.textureY);
      this.headModel[12] = new ModelRendererTurbo(this, 68, 66, this.textureX, this.textureY);
      this.headModel[13] = new ModelRendererTurbo(this, 68, 66, this.textureX, this.textureY);
      ...
      this.headModel[10].addShapeBox(4.2F, -9.4F, -1.5F, 4, 92, 69, 0.0F, 0.1F, 0.0F, 0.15F, -3.85F, 0.0F, 0.15F, -3.85F, 0.0F, -65.85F, 0.1F, 0.0F, -65.85F, 0.15F, -87.5F, 0.15F, -3.5F, -87.5F, 0.15F, -3.5F, -87.5F, -65.85F, 0.15F, -87.5F, -65.85F);
      this.headModel[10].setRotationPoint(0.0F, 0.0F, 0.0F);
      this.headModel[11].addShapeBox(-8.2F, -9.4F, -1.5F, 4, 92, 69, 0.0F, -3.85F, 0.0F, 0.15F, 0.1F, 0.0F, 0.15F, 0.1F, 0.0F, -65.85F, -3.85F, 0.0F, -65.85F, -3.5F, -87.5F, 0.15F, 0.15F, -87.5F, 0.15F, 0.15F, -87.5F, -65.85F, -3.5F, -87.5F, -65.85F);
      this.headModel[11].setRotationPoint(0.0F, 0.0F, 0.0F);
      this.headModel[12].addShapeBox(-1.5F, -9.8F, -8.5F, 69, 92, 4, 0.0F, 0.15F, 0.0F, -4.4F, -65.85F, 0.0F, -4.4F, -65.85F, 0.0F, 1.1F, 0.15F, 0.0F, 1.1F, 0.15F, -87.5F, -3.5F, -65.85F, -87.5F, -3.5F, -65.85F, -87.5F, 0.15F, 0.15F, -87.5F, 0.15F);
      this.headModel[12].setRotationPoint(0.0F, 0.0F, 0.0F);
      this.headModel[13].addShapeBox(-1.5F, -8.8F, 4.5F, 69, 92, 4, 0.0F, 0.15F, 0.0F, 1.1F, -65.85F, 0.0F, 1.1F, -65.85F, 0.0F, -4.2F, 0.15F, 0.0F, -4.2F, 0.15F, -87.5F, 0.15F, -65.85F, -87.5F, 0.15F, -65.85F, -87.5F, -3.8F, 0.15F, -87.5F, -3.8F);
