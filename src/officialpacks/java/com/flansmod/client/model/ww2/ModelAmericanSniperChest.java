...
public class ModelAmericanSniperChest extends ModelCustomArmour {
   ...
   public ModelAmericanSniperChest() {
      ...
      this.bodyModel[1] = new ModelRendererTurbo(this, 241, 33, this.textureX, this.textureY);
      this.bodyModel[2] = new ModelRendererTurbo(this, 241, 41, this.textureX, this.textureY);
      this.bodyModel[3] = new ModelRendererTurbo(this, 129, 49, this.textureX, this.textureY);
      this.bodyModel[4] = new ModelRendererTurbo(this, 233, 49, this.textureX, this.textureY);
      this.bodyModel[5] = new ModelRendererTurbo(this, 1, 57, this.textureX, this.textureY);
      this.bodyModel[6] = new ModelRendererTurbo(this, 81, 57, this.textureX, this.textureY);
      this.bodyModel[7] = new ModelRendererTurbo(this, 201, 57, this.textureX, this.textureY);
      this.bodyModel[8] = new ModelRendererTurbo(this, 17, 65, this.textureX, this.textureY);
      this.bodyModel[9] = new ModelRendererTurbo(this, 49, 65, this.textureX, this.textureY);
      this.bodyModel[10] = new ModelRendererTurbo(this, 129, 65, this.textureX, this.textureY);
      this.bodyModel[11] = new ModelRendererTurbo(this, 153, 65, this.textureX, this.textureY);
      this.bodyModel[12] = new ModelRendererTurbo(this, 57, 57, this.textureX, this.textureY);
      this.bodyModel[13] = new ModelRendererTurbo(this, 73, 25, this.textureX, this.textureY);
      this.bodyModel[14] = new ModelRendererTurbo(this, 113, 73, this.textureX, this.textureY);
      this.bodyModel[15] = new ModelRendererTurbo(this, 177, 73, this.textureX, this.textureY);
      ...
      this.leftArmModel[1] = new ModelRendererTurbo(this, 1, 41, this.textureX, this.textureY);
      this.leftArmModel[2] = new ModelRendererTurbo(this, 249, 17, this.textureX, this.textureY);
      this.leftArmModel[3] = new ModelRendererTurbo(this, 1, 25, this.textureX, this.textureY);
      this.leftArmModel[4] = new ModelRendererTurbo(this, 97, 73, this.textureX, this.textureY);
      ...
      this.rightArmModel[3] = new ModelRendererTurbo(this, 1, 73, this.textureX, this.textureY);
      this.rightArmModel[4] = new ModelRendererTurbo(this, 1, 41, this.textureX, this.textureY);
      ...
      this.leftLegModel[0].addShapeBox(-1.7F, 0.0F, -2.4F, 4, 3, 5, 0.0F, 0.3F, 0.1F, -0.1F, 0.0F, 0.1F, -0.1F, 0.0F, 0.1F, -0.4F, 0.3F, 0.1F, -0.4F, 0.1F, 0.1F, 0.2F, 0.2F, 0.1F, 0.2F, 0.2F, 0.1F, 0.0F, 0.1F, 0.1F, 0.0F);
      this.leftLegModel[0].setRotationPoint(0.0F, 0.0F, 0.0F);
      this.rightLegModel = new ModelRendererTurbo[1];
      this.rightLegModel[0] = new ModelRendererTurbo(this, 105, 57, this.textureX, this.textureY);
      this.rightLegModel[0].addShapeBox(-2.3F, 0.0F, -2.4F, 4, 3, 5, 0.0F, 0.0F, 0.1F, -0.1F, 0.3F, 0.1F, -0.1F, 0.3F, 0.1F, -0.4F, 0.0F, 0.1F, -0.4F, 0.2F, 0.1F, 0.2F, 0.1F, 0.1F, 0.2F, 0.1F, 0.1F, 0.0F, 0.2F, 0.1F, 0.0F);
