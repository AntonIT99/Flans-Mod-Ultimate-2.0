...
public class ModelGermanAssaultHat extends ModelCustomArmour {
   ...
   public ModelGermanAssaultHat() {
      ...
      this.headModel[0] = new ModelRendererTurbo(this, 159, 143, this.textureX, this.textureY);
      this.headModel[1] = new ModelRendererTurbo(this, 169, 146, this.textureX, this.textureY);
      this.headModel[2] = new ModelRendererTurbo(this, 1, 179, this.textureX, this.textureY);
      this.headModel[3] = new ModelRendererTurbo(this, 219, 133, this.textureX, this.textureY);
      this.headModel[4] = new ModelRendererTurbo(this, 148, 159, this.textureX, this.textureY);
      this.headModel[5] = new ModelRendererTurbo(this, 132, 151, this.textureX, this.textureY);
      this.headModel[6] = new ModelRendererTurbo(this, 157, 146, this.textureX, this.textureY);
      this.headModel[7] = new ModelRendererTurbo(this, 157, 146, this.textureX, this.textureY);
      this.headModel[8] = new ModelRendererTurbo(this, 123, 141, this.textureX, this.textureY);
