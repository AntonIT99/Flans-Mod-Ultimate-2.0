...
public class ModelGermanMedicHelmet extends ModelCustomArmour {
   ...
   public ModelGermanMedicHelmet() {
      ...
      this.headModel[9] = new ModelRendererTurbo(this, 119, 121, this.textureX, this.textureY);
      this.headModel[10] = new ModelRendererTurbo(this, 119, 121, this.textureX, this.textureY);
