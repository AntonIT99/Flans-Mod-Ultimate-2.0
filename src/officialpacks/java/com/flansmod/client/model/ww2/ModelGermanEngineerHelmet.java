...
public class ModelGermanEngineerHelmet extends ModelCustomArmour {
   ...
   public ModelGermanEngineerHelmet() {
      ...
      this.headModel[9] = new ModelRendererTurbo(this, 54, 149, this.textureX, this.textureY);
      this.headModel[10] = new ModelRendererTurbo(this, 54, 149, this.textureX, this.textureY);
      this.headModel[11] = new ModelRendererTurbo(this, 0, 150, this.textureX, this.textureY);
      this.headModel[12] = new ModelRendererTurbo(this, 0, 150, this.textureX, this.textureY);
      this.headModel[13] = new ModelRendererTurbo(this, 0, 150, this.textureX, this.textureY);
      this.headModel[14] = new ModelRendererTurbo(this, 0, 150, this.textureX, this.textureY);
      this.headModel[15] = new ModelRendererTurbo(this, 0, 150, this.textureX, this.textureY);
      this.headModel[16] = new ModelRendererTurbo(this, 0, 150, this.textureX, this.textureY);
      this.headModel[17] = new ModelRendererTurbo(this, 0, 163, this.textureX, this.textureY);
