 ...
 */
@Mod(PacksManagerMod.MOD_ID)
public class PacksManagerMod
{
    ...
    public PacksManagerMod(FMLJavaModLoadingContext context)
    {
    ...
    {
        try (InputStream input = PacksManagerMod.class.getResourceAsStream(BUNDLED_PACKS_VERSION_RESOURCE))
        {
            if (input == null)
            {
