...
public class ModelClonePantsIIShock extends ModelCustomArmour //Same as Filename
{
	int textureX = 64;
	int textureY = 64;

	public ModelClonePantsIIShock() //Same as Filename
	{
		...
		leftLegModel[5] = new ModelRendererTurbo(this, 1, 41, textureX, textureY); // Box 12
		leftLegModel[6] = new ModelRendererTurbo(this, 1, 54, textureX, textureY); // Box 13
		leftLegModel[7] = new ModelRendererTurbo(this, 1, 54, textureX, textureY); // Box 14
		...
		leftLegModel[5].addShapeBox(-1.99F, 1.91F, -2F, 4, 2, 4, 0F, 0.03F, 0.4F, -1.8F, 0.42F, 2.4F, -1.8F, 0.42F, 2.4F, -1.8F, 0.03F, 0.4F, -1.8F, 0.03F, 0.75F, -1.8F, 0.42F, 0.75F, -1.8F, 0.42F, 0.8F, -1.8F, 0.03F, 0.8F, -1.8F); // Box 12
		leftLegModel[5].setRotationPoint(0F, 0F, 0F);

		leftLegModel[6].addShapeBox(-2F, 1.41F, -2.42F, 4, 1, 4, 0F, 0.03F, -0.2F, 0F, 0.42F, -0.2F, 0F, 0.42F, -0.2F, -1F, 0.03F, -0.2F, -1F, 0.03F, -0.2F, 0F, 0.42F, -0.2F, 0F, 0.42F, -0.2F, -1F, 0.03F, -0.2F, -1F); // Box 13
		leftLegModel[6].setRotationPoint(0F, 0F, 0F);

		leftLegModel[7].addShapeBox(-2F, 2.41F, -2.42F, 4, 1, 4, 0F, 0.03F, -0.2F, 0F, 0.42F, -0.2F, 0F, 0.42F, -0.2F, -1F, 0.03F, -0.2F, -1F, 0.03F, -0.2F, 0F, 0.42F, -0.2F, 0F, 0.42F, -0.2F, -1F, 0.03F, -0.2F, -1F); // Box 14
		...
		rightLegModel[5] = new ModelRendererTurbo(this, 1, 41, textureX, textureY); // Box 15
		rightLegModel[6] = new ModelRendererTurbo(this, 1, 41, textureX, textureY); // Box 16
		rightLegModel[7] = new ModelRendererTurbo(this, 19, 41, textureX, textureY); // Box 17
		...
		rightLegModel[5].addShapeBox(-2F, 1.41F, -2.42F, 4, 1, 4, 0F, 0.42F, -0.2F, 0F, 0.03F, -0.2F, 0F, 0.03F, -0.2F, -1F, 0.42F, -0.2F, -1F, 0.42F, -0.2F, 0F, 0.03F, -0.2F, 0F, 0.03F, -0.2F, -1F, 0.42F, -0.2F, -1F); // Box 15
		rightLegModel[5].setRotationPoint(0F, 0F, 0F);

		rightLegModel[6].addShapeBox(-2F, 2.41F, -2.42F, 4, 1, 4, 0F, 0.42F, -0.2F, 0F, 0.03F, -0.2F, 0F, 0.03F, -0.2F, -1F, 0.42F, -0.2F, -1F, 0.42F, -0.2F, 0F, 0.03F, -0.2F, 0F, 0.03F, -0.2F, -1F, 0.42F, -0.2F, -1F); // Box 16
		rightLegModel[6].setRotationPoint(0F, 0F, 0F);

		rightLegModel[7].addShapeBox(-2.01F, 1.91F, -2F, 4, 2, 4, 0F, 0.42F, 2.4F, -1.8F, 0.03F, 0.4F, -1.8F, 0.03F, 0.4F, -1.8F, 0.42F, 2.4F, -1.8F, 0.42F, 0.75F, -1.8F, 0.03F, 0.75F, -1.8F, 0.03F, 0.8F, -1.8F, 0.42F, 0.8F, -1.8F); // Box 17
