...
public class ModelClonePantsCody extends ModelCustomArmour //Same as Filename
{
	int textureX = 64;
	int textureY = 64;

	public ModelClonePantsCody() //Same as Filename
	{
		...
		leftLegModel[5] = new ModelRendererTurbo(this, 44, 42, textureX, textureY); // Box 14
		...
		leftLegModel[5].addShapeBox(-2F, 2.91F, -2F, 4, 2, 4, 0F, 0.03F, 0.5F, 0.41F, 0.42F, 1.5F, 0.41F, 0.42F, 1.5F, 0.41F, 0.03F, 0.5F, 0.41F, 0.03F, -1.5F, 0.41F, 0.42F, -2.5F, 0.41F, 0.42F, -2.5F, 0.41F, 0.03F, -1.5F, 0.41F); // Box 14
		...
		rightLegModel[5].addShapeBox(-2F, 2.91F, -2F, 4, 2, 4, 0F, 0.42F, 1.5F, 0.41F, 0.03F, 0.5F, 0.41F, 0.03F, 0.5F, 0.41F, 0.42F, 1.5F, 0.41F, 0.42F, -2.5F, 0.41F, 0.03F, -1.5F, 0.41F, 0.03F, -1.5F, 0.41F, 0.42F, -2.5F, 0.41F); // Box 10
