...
public class ModelDC17 extends ModelGun
{
	...
	public ModelDC17()
	{
		...
		hasFlash = true;
		muzzleFlashPoint = new Vector3f(5.6F /16F, 3.5F /16F, 0F /16F);

		barrelAttachPoint = new Vector3f(-3.0F /16F, 2.5F /16F, 0F /16F);
		stockAttachPoint = new Vector3f(3F /16F, 3.5F /16F, 0F /16F);
		scopeAttachPoint = new Vector3f(0F /16F, 5F /16F, 0F /16F);
		gripAttachPoint = new Vector3f(-4/16F, 2.5F /16F, 0F /16F);
		gunSlideDistance = 0F;
